		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(ssrRenderComponent(_sfc_main$1, {
				...
				actions: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`<button class="ui-btn ui-btn--ghost" data-v-16acc1b5${_scopeId}><span class="btn-icon" data-v-16acc1b5${_scopeId}>📋</span> Quick Report — Today </button><button class="ui-btn ui-btn--ghost" data-v-16acc1b5${_scopeId}><span class="btn-icon" data-v-16acc1b5${_scopeId}>🏆</span> Top 10 Deals — Today </button><button class="ui-btn ui-btn--ghost" data-v-16acc1b5${_scopeId}><span class="btn-icon" data-v-16acc1b5${_scopeId}>⚙</span> Admin </button><button class="ui-btn ui-btn--ghost"${ssrIncludeBooleanAttr(itemsLoading.value) ? " disabled" : ""} data-v-16acc1b5${_scopeId}><span class="${ssrRenderClass([{ "spin": itemsLoading.value }, "btn-icon"])}" data-v-16acc1b5${_scopeId}>↻</span> ${ssrInterpolate(itemsLoading.value ? "Loading…" : "Refresh")}</button>`);
					else return [
						createVNode("button", {
			...
			_push(ssrRenderComponent(Modal_default, {
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<div class="report-modal" data-v-16acc1b5${_scopeId}>`);
						if (reportLoading.value) _push(`<p class="report-modal__state" data-v-16acc1b5${_scopeId}>Loading…</p>`);
						else if (reportError.value) _push(`<p class="report-modal__state report-modal__state--error" data-v-16acc1b5${_scopeId}>${ssrInterpolate(reportError.value)}</p>`);
						else if (!quickReport.value.length) _push(`<p class="report-modal__state" data-v-16acc1b5${_scopeId}>No orders today.</p>`);
						else {
							_push(`<table class="report-table" data-v-16acc1b5${_scopeId}><thead data-v-16acc1b5${_scopeId}><tr data-v-16acc1b5${_scopeId}><th data-v-16acc1b5${_scopeId}>Order</th><th data-v-16acc1b5${_scopeId}>Customer</th><th data-v-16acc1b5${_scopeId}>Type</th><th style="${ssrRenderStyle({ "text-align": "right" })}" data-v-16acc1b5${_scopeId}>Total</th></tr></thead><tbody data-v-16acc1b5${_scopeId}><!--[-->`);
							ssrRenderList(quickReport.value, (o) => {
								_push(`<tr data-v-16acc1b5${_scopeId}><td data-v-16acc1b5${_scopeId}>#${ssrInterpolate(o.id)}</td><td data-v-16acc1b5${_scopeId}>${ssrInterpolate(o.customer?.name || "Guest")}</td><td data-v-16acc1b5${_scopeId}>${ssrInterpolate(typeLabel(o.type))}</td><td class="report-table__money" data-v-16acc1b5${_scopeId}>${ssrInterpolate(money(o.grand_total))}</td></tr>`);
							});
							_push(`<!--]--></tbody><tfoot data-v-16acc1b5${_scopeId}><tr data-v-16acc1b5${_scopeId}><th colspan="3" data-v-16acc1b5${_scopeId}>Total · ${ssrInterpolate(quickReport.value.length)} order(s)</th><th class="report-table__money" data-v-16acc1b5${_scopeId}>${ssrInterpolate(money(reportTotal(quickReport.value)))}</th></tr></tfoot></table>`);
						}
						_push(`</div>`);
			...
			_push(ssrRenderComponent(Modal_default, {
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						...
						else if (!topTen.value.length) _push(`<p class="report-modal__state" data-v-16acc1b5${_scopeId}>No orders today.</p>`);
						else {
							_push(`<table class="report-table" data-v-16acc1b5${_scopeId}><thead data-v-16acc1b5${_scopeId}><tr data-v-16acc1b5${_scopeId}><th data-v-16acc1b5${_scopeId}>Order</th><th data-v-16acc1b5${_scopeId}>Customer</th><th data-v-16acc1b5${_scopeId}>Type</th><th style="${ssrRenderStyle({ "text-align": "right" })}" data-v-16acc1b5${_scopeId}>Total</th></tr></thead><tbody data-v-16acc1b5${_scopeId}><!--[-->`);
			...
			if (loadError.value) _push(`<div class="ui-alert ui-alert--danger" data-v-16acc1b5><span class="alert-icon" data-v-16acc1b5>⚠</span> ${ssrInterpolate(loadError.value)}</div>`);
			else _push(`<!---->`);
			...
			if (search.value) _push(`<button class="search-clear" aria-label="Clear search" data-v-16acc1b5>×</button>`);
			else _push(`<!---->`);
			...
			if (itemsLoading.value) {
				...
				if (search.value || activeCat.value) _push(`<button class="ui-btn ui-btn--sm" data-v-16acc1b5> Clear filters </button>`);
				else _push(`<!---->`);
				_push(`</div>`);
			} else {
				...
				ssrRenderList(filteredItems.value, (item) => {
					...
					if (item.image) _push(`<img${ssrRenderAttr("src", item.image)}${ssrRenderAttr("alt", item.name)} class="pos-tile__img" loading="lazy" data-v-16acc1b5>`);
					else _push(`<span class="pos-tile__img pos-tile__img--empty" aria-hidden="true" data-v-16acc1b5><span class="food-emoji" data-v-16acc1b5>${ssrInterpolate(getFoodEmoji(item.name))}</span></span>`);
			...
			if (cart.value.length) _push(`<button class="clear-btn" type="button" aria-label="Clear cart" data-v-16acc1b5> Clear all </button>`);
			else _push(`<!---->`);
			_push(`</div><!--[-->`);
			if (saveError.value) _push(`<div class="ui-alert ui-alert--danger" data-v-16acc1b5><span class="alert-icon" data-v-16acc1b5>⚠</span> ${ssrInterpolate(saveError.value)}</div>`);
			if (successMsg.value) _push(`<div class="ui-alert ui-alert--success" data-v-16acc1b5><span class="alert-icon" data-v-16acc1b5>✓</span> ${ssrInterpolate(successMsg.value)}</div>`);
			_push(`<!--]--><div class="${ssrRenderClass([{ "pos-lines--empty": !cart.value.length }, "pos-lines"])}" data-v-16acc1b5>`);
			if (!cart.value.length) _push(`<div class="pos-empty-state" data-v-16acc1b5><div class="empty-illustration" data-v-16acc1b5>🛒</div><p class="empty-title" data-v-16acc1b5>Your cart is empty</p><p class="empty-subtitle" data-v-16acc1b5>Tap items from the menu to start building an order.</p></div>`);
			else _push(`<!---->`);
			...
			if (cart.value.length) {
				...
				_push(ssrRenderComponent(_sfc_main$2, {
					...
					default: withCtx((_, _push, _parent, _scopeId) => {
						if (_push) _push(`<option value="dining" data-v-16acc1b5${_scopeId}>🍽 Dining In</option><option value="delivery" data-v-16acc1b5${_scopeId}>🚚 Delivery</option><option value="on-way" data-v-16acc1b5${_scopeId}>🥡 Takeaway</option>`);
						else return [
				...
				_push(ssrRenderComponent(_sfc_main$2, {
					...
					default: withCtx((_, _push, _parent, _scopeId) => {
						if (_push) {
							_push(`<option value="" data-v-16acc1b5${_scopeId}>— Select —</option><!--[-->`);
							ssrRenderList(places.value, (p) => {
								_push(`<option${ssrRenderAttr("value", p.id)} data-v-16acc1b5${_scopeId}>${ssrInterpolate(p.name)}</option>`);
							});
							_push(`<!--]-->`);
				...
				_push(ssrRenderComponent(_sfc_main$2, {
					...
					default: withCtx((_, _push, _parent, _scopeId) => {
						if (_push) _push(`<option value="pending" data-v-16acc1b5${_scopeId}>⏳ Pending</option><option value="preparing" data-v-16acc1b5${_scopeId}>👨‍🍳 Preparing</option><option value="on-way" data-v-16acc1b5${_scopeId}>🚚 On the way</option><option value="completed" data-v-16acc1b5${_scopeId}>✅ Completed</option>`);
						else return [
				...
				_push(ssrRenderComponent(_sfc_main$2, {
					...
					default: withCtx((_, _push, _parent, _scopeId) => {
						if (_push) _push(`<option${ssrRenderAttr("value", false)} data-v-16acc1b5${_scopeId}>⏳ Unpaid</option><option${ssrRenderAttr("value", true)} data-v-16acc1b5${_scopeId}>✅ Paid</option>`);
				...
				_push(ssrRenderComponent(_sfc_main$2, {
					...
					default: withCtx((_, _push, _parent, _scopeId) => {
						if (_push) _push(`<option value="amount" data-v-16acc1b5${_scopeId}>Fixed Amount</option><option value="percentage" data-v-16acc1b5${_scopeId}>Percentage</option>`);
			...
			if (cart.value.length) {
				...
				if (appliedPromo.value) _push(`<button type="button" class="ui-btn ui-btn--ghost" data-v-16acc1b5> Remove </button>`);
				else _push(`<button type="button" class="ui-btn ui-btn--ghost"${ssrIncludeBooleanAttr(promoChecking.value || !promoInput.value.trim()) ? " disabled" : ""} data-v-16acc1b5>${ssrInterpolate(promoChecking.value ? "Checking…" : "Apply")}</button>`);
				_push(`</div>`);
				if (promoError.value) _push(`<p class="pos-crm__hint pos-crm__hint--bad" data-v-16acc1b5>${ssrInterpolate(promoError.value)}</p>`);
				else if (appliedPromo.value) _push(`<p class="pos-crm__hint pos-crm__hint--ok" data-v-16acc1b5>${ssrInterpolate(appliedPromo.value.code)} applied — ${ssrInterpolate(money(promoDiscount.value))} off. </p>`);
				else _push(`<p class="pos-crm__hint" data-v-16acc1b5>The discount is priced by the server, not here.</p>`);
				...
				if (pointsError.value) _push(`<p class="pos-crm__hint pos-crm__hint--bad" data-v-16acc1b5>${ssrInterpolate(pointsError.value)}</p>`);
				else _push(`<p class="pos-crm__hint" data-v-16acc1b5>${ssrInterpolate(pointsHint.value)}</p>`);
				_push(`</div></div></div>`);
			} else _push(`<!---->`);
			if (cart.value.length) {
				...
				if (discountValue.value > 0) _push(`<div class="pos-total-row" data-v-16acc1b5><span class="total-label discount" data-v-16acc1b5>Discount</span><span class="total-value discount" data-v-16acc1b5>− ${ssrInterpolate(money(discountValue.value))}</span></div>`);
				else _push(`<!---->`);
				if (promoDiscount.value > 0) _push(`<div class="pos-total-row" data-v-16acc1b5><span class="total-label discount" data-v-16acc1b5>Promo · ${ssrInterpolate(appliedPromo.value.code)}</span><span class="total-value discount" data-v-16acc1b5>− ${ssrInterpolate(money(promoDiscount.value))}</span></div>`);
				else _push(`<!---->`);
				if (loyaltyDiscount.value > 0) _push(`<div class="pos-total-row" data-v-16acc1b5><span class="total-label discount" data-v-16acc1b5>Points · ${ssrInterpolate(redeemPointsValue.value)}</span><span class="total-value discount" data-v-16acc1b5>− ${ssrInterpolate(money(loyaltyDiscount.value))}</span></div>`);
				else _push(`<!---->`);
				if (serviceCharges.value > 0) _push(`<div class="pos-total-row" data-v-16acc1b5><span class="total-label" data-v-16acc1b5>Service Charge</span><span class="total-value" data-v-16acc1b5>+ ${ssrInterpolate(money(serviceCharges.value))}</span></div>`);
				else _push(`<!---->`);
				...
				if (discountsOverflow.value) _push(`<p class="pos-crm__hint pos-crm__hint--bad" data-v-16acc1b5> The discounts together exceed the subtotal — reduce one of them. </p>`);
				else if (pointsToEarn.value > 0) _push(`<p class="pos-crm__hint pos-crm__hint--ok" data-v-16acc1b5> Earns ${ssrInterpolate(pointsToEarn.value)} point(s) once saved. </p>`);
				else _push(`<!---->`);
				_push(`</div>`);
			} else _push(`<!---->`);
			if (cart.value.length) {
				...
				if (saving.value) _push(`<span class="btn-spinner" data-v-16acc1b5></span>`);
				else _push(`<span data-v-16acc1b5>Place Order · ${ssrInterpolate(money(grandTotal.value))}</span>`);
				_push(`</button></div>`);
			} else _push(`<!---->`);
...
var POS_default = /*#__PURE__*/ _plugin_vue_export_helper_default(_sfc_main, [["__scopeId", "data-v-16acc1b5"]]);
//#endregion
