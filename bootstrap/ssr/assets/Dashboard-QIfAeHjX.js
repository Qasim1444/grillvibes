...
<<<<<<<< HEAD:bootstrap/ssr/assets/Dashboard-Bh_4wrUY.js
import { t as AdminLayout_default } from "./AdminLayout-CRfe4OCB.js";
========
import { t as AdminLayout_default } from "./AdminLayout-Bwr7FeyI.js";
>>>>>>>> 92defc434e56ef7274fc5083cb00cd7073d56b27:bootstrap/ssr/assets/Dashboard-QIfAeHjX.js
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(ssrRenderComponent(StatCard_default, {
				...
				icon: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`<svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-ee0a73df${_scopeId}><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2" data-v-ee0a73df${_scopeId}></path><circle cx="12" cy="7" r="4" data-v-ee0a73df${_scopeId}></circle></svg>`);
					else return [(openBlock(), createBlock("svg", {
						viewBox: "0 0 24 24",
						width: "20",
						height: "20",
			...
			_push(ssrRenderComponent(StatCard_default, {
				...
				icon: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`<svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-ee0a73df${_scopeId}><path d="M3 2v7c0 1.1.9 2 2 2h0a2 2 0 0 0 2-2V2M5 2v20M17 2c-1.7 0-3 2-3 5s1.3 5 3 5v10" data-v-ee0a73df${_scopeId}></path></svg>`);
					else return [(openBlock(), createBlock("svg", {
						viewBox: "0 0 24 24",
						width: "20",
						height: "20",
			...
			_push(ssrRenderComponent(StatCard_default, {
				...
				icon: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`<svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-ee0a73df${_scopeId}><rect x="3" y="4" width="18" height="16" rx="2" data-v-ee0a73df${_scopeId}></rect><path d="M3 10h18" data-v-ee0a73df${_scopeId}></path></svg>`);
					else return [(openBlock(), createBlock("svg", {
						viewBox: "0 0 24 24",
						width: "20",
						height: "20",
			...
			if (!topCategories.value.length) _push(`<p class="data-table__empty" style="${ssrRenderStyle({ "padding": "20px 0" })}" data-v-ee0a73df>No categories yet.</p>`);
			else _push(`<!---->`);
			_push(`<!--[-->`);
			ssrRenderList(topCategories.value, (c, i) => {
				_push(`<div class="cat__row" data-v-ee0a73df><span class="cat__name" data-v-ee0a73df>${ssrInterpolate(c.name)}</span><span class="cat__bar" data-v-ee0a73df><span class="cat__fill" style="${ssrRenderStyle({
					width: c.pct + "%",
					background: barColor(i)
				})}" data-v-ee0a73df></span></span><span class="cat__val" data-v-ee0a73df>${ssrInterpolate(c.pct)}%</span></div>`);
			});
			...
			if (reportsLoading.value) _push(`<tr data-v-ee0a73df><td colspan="2" class="data-table__empty" data-v-ee0a73df>Loading…</td></tr>`);
			else if (!summary.value.ordersByType.length) _push(`<tr data-v-ee0a73df><td colspan="2" class="data-table__empty" data-v-ee0a73df>No sales in this range.</td></tr>`);
			else _push(`<!---->`);
			_push(`<!--[-->`);
			...
			_push(`<!--]--></tbody>`);
			if (summary.value.ordersByType.length) _push(`<tfoot data-v-ee0a73df><tr data-v-ee0a73df><th data-v-ee0a73df>Total</th><th class="money" style="${ssrRenderStyle({ "text-align": "right" })}" data-v-ee0a73df>${ssrInterpolate(money(summary.value.totalGrandTotal))}</th></tr></tfoot>`);
			else _push(`<!---->`);
			...
			if (reportsLoading.value) _push(`<tr data-v-ee0a73df><td colspan="4" class="data-table__empty" data-v-ee0a73df>Loading…</td></tr>`);
			else if (!categorySales.value.length) _push(`<tr data-v-ee0a73df><td colspan="4" class="data-table__empty" data-v-ee0a73df>No category sales in this range.</td></tr>`);
			else _push(`<!---->`);
			_push(`<!--[-->`);
			...
			if (reportsLoading.value) _push(`<tr data-v-ee0a73df><td colspan="4" class="data-table__empty" data-v-ee0a73df>Loading…</td></tr>`);
			else if (!itemQty.value.categories.length) _push(`<tr data-v-ee0a73df><td colspan="4" class="data-table__empty" data-v-ee0a73df>No item sales in this range.</td></tr>`);
			else _push(`<!---->`);
			_push(`<!--[-->`);
			...
			if (reportsLoading.value) _push(`<tr data-v-ee0a73df><td colspan="4" class="data-table__empty" data-v-ee0a73df>Loading…</td></tr>`);
			else if (!itemQtyCurrent.value.categories.length) _push(`<tr data-v-ee0a73df><td colspan="4" class="data-table__empty" data-v-ee0a73df>No item sales in this range.</td></tr>`);
			else _push(`<!---->`);
			_push(`<!--[-->`);
			...
			if (reportsLoading.value) _push(`<tr data-v-ee0a73df><td colspan="4" class="data-table__empty" data-v-ee0a73df>Loading…</td></tr>`);
			else if (!quickReport.value.length) _push(`<tr data-v-ee0a73df><td colspan="4" class="data-table__empty" data-v-ee0a73df>No orders today.</td></tr>`);
			else _push(`<!---->`);
			_push(`<!--[-->`);
			ssrRenderList(quickReport.value, (o) => {
				_push(`<tr data-v-ee0a73df><td data-v-ee0a73df>#${ssrInterpolate(o.id)}</td><td data-v-ee0a73df>${ssrInterpolate(o.customer?.name || "Guest")}</td><td data-v-ee0a73df>${ssrInterpolate(typeLabel(o.type))}</td><td class="money" style="${ssrRenderStyle({ "text-align": "right" })}" data-v-ee0a73df>${ssrInterpolate(money(o.grand_total))}</td></tr>`);
			});
			...
			if (reportsLoading.value) _push(`<tr data-v-ee0a73df><td colspan="3" class="data-table__empty" data-v-ee0a73df>Loading…</td></tr>`);
			else if (!topTen.value.length) _push(`<tr data-v-ee0a73df><td colspan="3" class="data-table__empty" data-v-ee0a73df>No orders today.</td></tr>`);
			else _push(`<!---->`);
			_push(`<!--[-->`);
			ssrRenderList(topTen.value, (o) => {
				_push(`<tr data-v-ee0a73df><td data-v-ee0a73df>#${ssrInterpolate(o.id)}</td><td data-v-ee0a73df>${ssrInterpolate(o.customer?.name || "Guest")}</td><td class="money" style="${ssrRenderStyle({ "text-align": "right" })}" data-v-ee0a73df>${ssrInterpolate(money(o.grand_total))}</td></tr>`);
			});
			...
			if (reportsLoading.value) _push(`<tr data-v-ee0a73df><td colspan="5" class="data-table__empty" data-v-ee0a73df>Loading…</td></tr>`);
			else if (!deletedOrders.value.length) _push(`<tr data-v-ee0a73df><td colspan="5" class="data-table__empty" data-v-ee0a73df>No orders deleted today.</td></tr>`);
			else _push(`<!---->`);
			_push(`<!--[-->`);
...
var Dashboard_default = /*#__PURE__*/ _plugin_vue_export_helper_default(_sfc_main, [["__scopeId", "data-v-ee0a73df"]]);
//#endregion
