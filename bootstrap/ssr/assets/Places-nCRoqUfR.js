<<<<<<<< HEAD:bootstrap/ssr/assets/Places-Di7pbTir.js
...
>>>>>>>> 92defc434e56ef7274fc5083cb00cd7073d56b27:bootstrap/ssr/assets/Places-nCRoqUfR.js
...
var _sfc_main = /*@__PURE__*/ Object.assign({ layout: AdminLayout_default }, {
	...
	setup(__props) {
		...
		const savePlace = () => {
			...
			if (form.id) form.put(`/places/${form.id}`, opts);
			else form.post("/places", opts);
		};
