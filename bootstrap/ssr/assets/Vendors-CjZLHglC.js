...
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderAttr, ssrRenderStyle, ssrIncludeBooleanAttr, ssrLooseContain, ssrLooseEqual } from "vue/server-renderer";
...
const _sfc_main = /* @__PURE__ */ Object.assign({ layout: AdminLayout }, {
  ...
  setup(__props) {
    ...
    const vendors = computed(() => {
      var _a2;
      return ((_a2 = props.vendors) == null ? void 0 : _a2.data) ?? [];
    });
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1, {
        ...
        actions: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (unref(can)("procurement.vendors.create")) {
              _push2(`<button class="ui-btn ui-btn--primary" data-v-ca10fd54${_scopeId}> + New Vendor </button>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
            return [
              unref(can)("procurement.vendors.create") ? (openBlock(), createBlock("button", {
                key: 0,
      ...
      _push(ssrRenderComponent(DataTable, {
        ...
        "cell:name": withCtx(({ row }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<strong data-v-ca10fd54${_scopeId}>${ssrInterpolate(row.name)}</strong>`);
            if (!row.is_active) {
              _push2(`<span class="ui-badge ui-badge--muted vd__pill" data-v-ca10fd54${_scopeId}>Inactive</span>`);
            } else {
              _push2(`<!---->`);
            }
            if (row.contact_person) {
              _push2(`<span class="vd__sub" data-v-ca10fd54${_scopeId}>${ssrInterpolate(row.contact_person)}</span>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
        ...
        "cell:contact": withCtx(({ row }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (row.phone) {
              _push2(`<span class="vd__block" data-v-ca10fd54${_scopeId}>${ssrInterpolate(row.phone)}</span>`);
            } else {
              _push2(`<!---->`);
            }
            if (row.email) {
              _push2(`<span class="vd__block vd__muted" data-v-ca10fd54${_scopeId}>${ssrInterpolate(row.email)}</span>`);
            } else {
              _push2(`<!---->`);
            }
            if (!row.phone && !row.email) {
              _push2(`<span class="vd__muted" data-v-ca10fd54${_scopeId}>—</span>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
        ...
        "cell:payment_terms": withCtx(({ value }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (value) {
              _push2(`<span data-v-ca10fd54${_scopeId}>${ssrInterpolate(value)}</span>`);
            } else {
              _push2(`<span class="vd__muted" data-v-ca10fd54${_scopeId}>—</span>`);
            }
          } else {
        ...
        "cell:purchase_orders": withCtx(({ row }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span data-v-ca10fd54${_scopeId}>${ssrInterpolate(row.purchase_orders)}</span>`);
            if (row.open_purchase_orders > 0) {
              _push2(`<span class="ui-badge ui-badge--warning vd__pill" data-v-ca10fd54${_scopeId}>${ssrInterpolate(row.open_purchase_orders)} open </span>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
            return [
              createVNode("span", null, toDisplayString(row.purchase_orders), 1),
              row.open_purchase_orders > 0 ? (openBlock(), createBlock("span", {
                key: 0,
        ...
        "cell:received_total": withCtx(({ row }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<strong data-v-ca10fd54${_scopeId}>${ssrInterpolate(fmt(row.received_total))}</strong><span class="vd__sub" data-v-ca10fd54${_scopeId}>${ssrInterpolate(row.goods_receipts)} delivery(s)</span>`);
          } else {
            return [
              createVNode("strong", null, toDisplayString(fmt(row.received_total)), 1),
              createVNode("span", { class: "vd__sub" }, toDisplayString(row.goods_receipts) + " delivery(s)", 1)
            ];
          }
        }),
        actions: withCtx(({ row }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (unref(can)("procurement.vendors.update")) {
              _push2(`<button class="ui-btn ui-btn--ghost ui-btn--sm" data-v-ca10fd54${_scopeId}>Edit</button>`);
            } else {
              _push2(`<!---->`);
            }
            if (unref(can)("procurement.vendors.delete")) {
              _push2(`<button class="ui-btn ui-btn--danger ui-btn--sm" data-v-ca10fd54${_scopeId}>Delete</button>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
            return [
              unref(can)("procurement.vendors.update") ? (openBlock(), createBlock("button", {
                key: 0,
                class: "ui-btn ui-btn--ghost ui-btn--sm",
                onClick: ($event) => openEdit(row)
              }, "Edit", 8, ["onClick"])) : createCommentVNode("", true),
              unref(can)("procurement.vendors.delete") ? (openBlock(), createBlock("button", {
                key: 1,
      ...
      _push(ssrRenderComponent(Modal, {
        ...
        footer: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<button class="ui-btn ui-btn--ghost" data-v-ca10fd54${_scopeId}>Cancel</button><button class="ui-btn ui-btn--primary"${ssrIncludeBooleanAttr(unref(form).processing) ? " disabled" : ""} data-v-ca10fd54${_scopeId}>Save</button>`);
          } else {
            return [
              createVNode("button", {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<div class="form-grid-2" data-v-ca10fd54${_scopeId}>`);
            _push2(ssrRenderComponent(_sfc_main$2, {
            ...
            _push2(ssrRenderComponent(_sfc_main$2, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<option${ssrRenderAttr("value", true)} data-v-ca10fd54${_scopeId2}>Active</option><option${ssrRenderAttr("value", false)} data-v-ca10fd54${_scopeId2}>Inactive</option>`);
                } else {
                  return [
            ...
            _push2(`<p class="vd__hint" data-v-ca10fd54${_scopeId}> Mark a vendor inactive to keep it off new purchase orders without touching its history. </p>`);
          } else {
            return [
...
const Vendors = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-ca10fd54"]]);
export {
  Vendors as default
};
