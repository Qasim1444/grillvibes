import { computed, ref, watch, mergeProps, withCtx, unref, openBlock, createBlock, createCommentVNode, createVNode, toDisplayString, Fragment, renderList, createTextVNode, useSSRContext } from "vue";
...
const _sfc_main = /* @__PURE__ */ Object.assign({ layout: AdminLayout }, {
  ...
  setup(__props) {
    ...
    watch([search, statusFilter, accountFilter, branchFilter], () => {
      clearTimeout(timer);
    ...
    const openCreate = () => {
      ...
      form.petty_cash_account_id = ((_a2 = props.accounts[0]) == null ? void 0 : _a2.id) ?? "";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1, {
        ...
        actions: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (unref(can)("vouchers.create")) {
              _push2(`<button class="ui-btn ui-btn--primary" data-v-445fa6d2${_scopeId}>+ New Voucher</button>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
            return [
              unref(can)("vouchers.create") ? (openBlock(), createBlock("button", {
                key: 0,
      ...
      _push(ssrRenderComponent(DataTable, {
        ...
        "cell:voucher_date": withCtx(({ value }, _push2, _parent2, _scopeId) => {
          if (_push2) {
        ...
        "cell:claimant_label": withCtx(({ value }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (value) {
              _push2(`<span data-v-445fa6d2${_scopeId}>${ssrInterpolate(value)}</span>`);
            } else {
              _push2(`<span class="vc__muted" data-v-445fa6d2${_scopeId}>—</span>`);
            }
          } else {
            return [
        ...
        "cell:purpose": withCtx(({ row }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`${ssrInterpolate(row.purpose)} `);
            if (row.reference) {
              _push2(`<span class="vc__code" data-v-445fa6d2${_scopeId}>${ssrInterpolate(row.reference)}</span>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
            return [
              createTextVNode(toDisplayString(row.purpose) + " ", 1),
              row.reference ? (openBlock(), createBlock("span", {
                key: 0,
                class: "vc__code"
        ...
        "cell:expenses": withCtx(({ row }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (!row.expenses.length) {
              _push2(`<span class="vc__muted" data-v-445fa6d2${_scopeId}>—</span>`);
            } else {
              _push2(`<!---->`);
            }
            ...
            ssrRenderList(row.expenses, (e) => {
              _push2(`<span class="vc__chip"${ssrRenderAttr("title", e.description)} data-v-445fa6d2${_scopeId}>${ssrInterpolate(e.expense_number)}</span>`);
            });
            _push2(`<!--]-->`);
          } else {
            return [
              !row.expenses.length ? (openBlock(), createBlock("span", {
                key: 0,
                class: "vc__muted"
              }, "—")) : createCommentVNode("", true),
              (openBlock(true), createBlock(Fragment, null, renderList(row.expenses, (e) => {
        ...
        "cell:amount": withCtx(({ value }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<strong data-v-445fa6d2${_scopeId}>${ssrInterpolate(fmt(value))}</strong>`);
          } else {
            return [
        ...
        "cell:status": withCtx(({ row }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="${ssrRenderClass([statusClass(row.status), "ui-badge"])}" data-v-445fa6d2${_scopeId}>${ssrInterpolate(statusLabel(row.status))}</span>`);
            if (row.rejection_reason) {
              _push2(`<span class="vc__code"${ssrRenderAttr("title", row.rejection_reason)} data-v-445fa6d2${_scopeId}>why?</span>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
            return [
              ...
              row.rejection_reason ? (openBlock(), createBlock("span", {
                key: 0,
                class: "vc__code",
        ...
        actions: withCtx(({ row }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (unref(can)("vouchers.approve") && row.status === "pending") {
              _push2(`<button class="ui-btn ui-btn--secondary ui-btn--sm" data-v-445fa6d2${_scopeId}>Approve</button>`);
            } else {
              _push2(`<!---->`);
            }
            if (unref(can)("vouchers.approve") && row.status === "pending") {
              _push2(`<button class="ui-btn ui-btn--ghost ui-btn--sm" data-v-445fa6d2${_scopeId}>Reject</button>`);
            } else {
              _push2(`<!---->`);
            }
            if (unref(can)("vouchers.update") && row.status === "pending") {
              _push2(`<button class="ui-btn ui-btn--ghost ui-btn--sm" data-v-445fa6d2${_scopeId}>Edit</button>`);
            } else {
              _push2(`<!---->`);
            }
            if (unref(can)("vouchers.delete")) {
              _push2(`<button class="ui-btn ui-btn--danger ui-btn--sm" data-v-445fa6d2${_scopeId}>Delete</button>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
      ...
      _push(ssrRenderComponent(Modal, {
        ...
        footer: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<button class="ui-btn ui-btn--ghost" data-v-445fa6d2${_scopeId}>Cancel</button><button class="ui-btn ui-btn--primary"${ssrIncludeBooleanAttr(unref(form).processing) ? " disabled" : ""} data-v-445fa6d2${_scopeId}>Save</button>`);
          } else {
            return [
              createVNode("button", {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<div class="form-grid-2" data-v-445fa6d2${_scopeId}>`);
            _push2(ssrRenderComponent(_sfc_main$2, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<option value="" data-v-445fa6d2${_scopeId2}>— Not a system user —</option><!--[-->`);
                  ssrRenderList(props.claimants, (c) => {
                    _push3(`<option${ssrRenderAttr("value", c.id)} data-v-445fa6d2${_scopeId2}>${ssrInterpolate(c.name)}</option>`);
                  });
                  _push3(`<!--]-->`);
                } else {
                  return [
                    createVNode("option", { value: "" }, "— Not a system user —"),
                    (openBlock(true), createBlock(Fragment, null, renderList(props.claimants, (c) => {
            ...
            _push2(ssrRenderComponent(_sfc_main$2, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<option value="" disabled data-v-445fa6d2${_scopeId2}>Select fund</option><!--[-->`);
                  ssrRenderList(props.accounts, (a) => {
                    _push3(`<option${ssrRenderAttr("value", a.id)} data-v-445fa6d2${_scopeId2}>${ssrInterpolate(a.name)} (${ssrInterpolate(fmt(a.current_balance))})</option>`);
                  });
                  _push3(`<!--]-->`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_sfc_main$2, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<option value="" data-v-445fa6d2${_scopeId2}>Current Outlet</option><!--[-->`);
                  ssrRenderList(props.branches, (branch) => {
                    _push3(`<option${ssrRenderAttr("value", branch.id)} data-v-445fa6d2${_scopeId2}>${ssrInterpolate(branch.name)}</option>`);
                  });
                  _push3(`<!--]-->`);
                } else {
                  return [
            ...
            _push2(`</div><h3 class="vc__picker-title" data-v-445fa6d2${_scopeId}> Expenses Claimed * <span class="vc__muted vc__picker-hint" data-v-445fa6d2${_scopeId}>${ssrInterpolate(pickerHint.value)}</span></h3>`);
            if (unref(form).errors.expense_ids) {
              _push2(`<p class="vc__err" data-v-445fa6d2${_scopeId}>${ssrInterpolate(unref(form).errors.expense_ids)}</p>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<div class="vc__picker" data-v-445fa6d2${_scopeId}>`);
            if (!pickable.value.length) {
              _push2(`<p class="vc__muted vc__picker-empty" data-v-445fa6d2${_scopeId}>No unclaimed expenses available. Record an expense first.</p>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<!--[-->`);
            ssrRenderList(pickable.value, (e) => {
              _push2(`<label class="${ssrRenderClass([{ "vc__row--on": isPicked(e.id) }, "vc__row"])}" data-v-445fa6d2${_scopeId}><input type="checkbox"${ssrIncludeBooleanAttr(isPicked(e.id)) ? " checked" : ""} data-v-445fa6d2${_scopeId}><span class="vc__row-num" data-v-445fa6d2${_scopeId}>${ssrInterpolate(e.expense_number)}</span><span class="vc__row-desc" data-v-445fa6d2${_scopeId}>${ssrInterpolate(e.description)} <span class="vc__code" data-v-445fa6d2${_scopeId}>${ssrInterpolate(fmtDate(e.expense_date))} · ${ssrInterpolate(paidViaLabel(e.paid_via))}</span></span><span class="vc__row-amt" data-v-445fa6d2${_scopeId}>${ssrInterpolate(fmt(e.amount))}</span></label>`);
            });
            _push2(`<!--]--></div><div class="vc__totals" data-v-445fa6d2${_scopeId}><div class="vc__total-row" data-v-445fa6d2${_scopeId}><span data-v-445fa6d2${_scopeId}>Total claim</span><strong data-v-445fa6d2${_scopeId}>${ssrInterpolate(fmt(claimTotal.value))}</strong></div>`);
            if (selectedFund.value) {
              _push2(`<div class="${ssrRenderClass([{ "vc__over": balanceAfter.value < 0 }, "vc__total-row vc__total-row--sub"])}" data-v-445fa6d2${_scopeId}><span data-v-445fa6d2${_scopeId}>${ssrInterpolate(selectedFund.value.name)} balance after</span><strong data-v-445fa6d2${_scopeId}>${ssrInterpolate(fmt(balanceAfter.value))}</strong></div>`);
            } else {
              _push2(`<!---->`);
            }
            if (selectedFund.value && balanceAfter.value < 0) {
              _push2(`<p class="vc__err" data-v-445fa6d2${_scopeId}> This claim is larger than the fund holds — top the float up, or split the claim. </p>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div>`);
            ...
            _push2(`<p class="vc__hint" data-v-445fa6d2${_scopeId}>Raising the voucher posts one combined disbursement to the fund&#39;s ledger. A claimed expense stops posting its own petty-cash line, so a petty-cash expense is never deducted twice.</p>`);
          } else {
            return [
              ...
              createVNode("h3", { class: "vc__picker-title" }, [
                createTextVNode(" Expenses Claimed * "),
                createVNode("span", { class: "vc__muted vc__picker-hint" }, toDisplayString(pickerHint.value), 1)
              ]),
              ...
              createVNode("div", { class: "vc__picker" }, [
                !pickable.value.length ? (openBlock(), createBlock("p", {
                  key: 0,
                  class: "vc__muted vc__picker-empty"
                }, "No unclaimed expenses available. Record an expense first.")) : createCommentVNode("", true),
                (openBlock(true), createBlock(Fragment, null, renderList(pickable.value, (e) => {
                  return openBlock(), createBlock("label", {
                    ...
                    createVNode("span", { class: "vc__row-desc" }, [
                      createTextVNode(toDisplayString(e.description) + " ", 1),
                      createVNode("span", { class: "vc__code" }, toDisplayString(fmtDate(e.expense_date)) + " · " + toDisplayString(paidViaLabel(e.paid_via)), 1)
                    ]),
              ...
              createVNode("div", { class: "vc__totals" }, [
                createVNode("div", { class: "vc__total-row" }, [
                  createVNode("span", null, "Total claim"),
                  createVNode("strong", null, toDisplayString(fmt(claimTotal.value)), 1)
                ]),
                selectedFund.value ? (openBlock(), createBlock("div", {
                  key: 0,
                  class: ["vc__total-row vc__total-row--sub", { "vc__over": balanceAfter.value < 0 }]
                }, [
                  createVNode("span", null, toDisplayString(selectedFund.value.name) + " balance after", 1),
                  createVNode("strong", null, toDisplayString(fmt(balanceAfter.value)), 1)
...
const Vouchers = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-445fa6d2"]]);
export {
  Vouchers as default
};
