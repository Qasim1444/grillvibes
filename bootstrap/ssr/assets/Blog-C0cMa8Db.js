...
var _sfc_main = /*@__PURE__*/ Object.assign({ layout: AdminLayout_default }, {
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<div${ssrRenderAttrs(mergeProps({ class: "page" }, _attrs))} data-v-f8ad0d3f>`);
			_push(ssrRenderComponent(_sfc_main$1, {
				...
				actions: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						if (unref(can)("blog.update")) _push(`<button type="button" class="ui-btn ui-btn--ghost" data-v-f8ad0d3f${_scopeId}> Manage Categories &amp; Tags </button>`);
						else _push(`<!---->`);
						if (unref(can)("blog.create")) _push(`<button type="button" class="ui-btn ui-btn--primary" data-v-f8ad0d3f${_scopeId}> + New Post </button>`);
						else _push(`<!---->`);
			...
			_push(ssrRenderComponent(DataTable_default, {
				...
				"cell:status": withCtx(({ value }, _push, _parent, _scopeId) => {
					if (_push) _push(`<span class="${ssrRenderClass([statusClass(value), "ui-badge"])}" data-v-f8ad0d3f${_scopeId}>${ssrInterpolate(value)}</span>`);
				...
				actions: withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) {
						if (unref(can)("blog.update")) _push(`<button type="button" class="ui-btn ui-btn--ghost ui-btn--sm" data-v-f8ad0d3f${_scopeId}> Edit </button>`);
						else _push(`<!---->`);
						if (unref(can)("blog.delete")) _push(`<button type="button" class="ui-btn ui-btn--danger ui-btn--sm" data-v-f8ad0d3f${_scopeId}> Delete </button>`);
						else _push(`<!---->`);
					} else return [unref(can)("blog.update") ? (openBlock(), createBlock("button", {
						key: 0,
						type: "button",
			...
			_push(ssrRenderComponent(Modal_default, {
				...
				footer: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`<button type="button" class="ui-btn ui-btn--ghost" data-v-f8ad0d3f${_scopeId}> Cancel </button><button type="button" class="ui-btn ui-btn--primary"${ssrIncludeBooleanAttr(unref(form).processing) ? " disabled" : ""} data-v-f8ad0d3f${_scopeId}>${ssrInterpolate(unref(form).processing ? "Saving..." : "Save")}</button>`);
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						...
						_push(`<div class="blog-form-grid" data-v-f8ad0d3f${_scopeId}>`);
						_push(ssrRenderComponent(_sfc_main$2, {
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) _push(`<option value="draft" data-v-f8ad0d3f${_scopeId}> Draft </option><option value="published" data-v-f8ad0d3f${_scopeId}> Published </option><option value="scheduled" data-v-f8ad0d3f${_scopeId}> Scheduled </option>`);
								else return [
						...
						_push(`</div><p class="blog-form-hint" data-v-f8ad0d3f${_scopeId}> Select one or more categories and tags. Add new options from Manage Categories &amp; Tags. </p>`);
						_push(ssrRenderComponent(_sfc_main$2, {
						...
						_push(`<div class="blog-form-grid" data-v-f8ad0d3f${_scopeId}><div class="multi-select-field" data-v-f8ad0d3f${_scopeId}><label class="ui-label" data-v-f8ad0d3f${_scopeId}> Categories </label><div class="${ssrRenderClass([{ "is-open": categoryDropdownOpen.value }, "multi-select-control"])}" data-v-f8ad0d3f${_scopeId}><div class="multi-select-values" data-v-f8ad0d3f${_scopeId}><!--[-->`);
						ssrRenderList(selectedCategories.value, (category) => {
							_push(`<span class="multi-select-chip" data-v-f8ad0d3f${_scopeId}>${ssrInterpolate(category.name)} <button type="button" class="multi-select-chip-remove" data-v-f8ad0d3f${_scopeId}> × </button></span>`);
						});
						_push(`<!--]-->`);
						if (unref(form).category_ids.length === 0) _push(`<span class="multi-select-placeholder" data-v-f8ad0d3f${_scopeId}> Select categories </span>`);
						else _push(`<!---->`);
						_push(`</div><span class="multi-select-arrow" data-v-f8ad0d3f${_scopeId}>${ssrInterpolate(categoryDropdownOpen.value ? "▲" : "▼")}</span></div>`);
						if (categoryDropdownOpen.value) {
							_push(`<div class="multi-select-dropdown" data-v-f8ad0d3f${_scopeId}><div class="multi-select-search-box" data-v-f8ad0d3f${_scopeId}><input${ssrRenderAttr("value", categorySearch.value)} type="text" class="multi-select-search" placeholder="Search categories..." data-v-f8ad0d3f${_scopeId}></div>`);
							if (filteredCategories.value.length) _push(`<div class="multi-select-select-all" data-v-f8ad0d3f${_scopeId}><input type="checkbox"${ssrIncludeBooleanAttr(allCategoriesSelected.value) ? " checked" : ""} data-v-f8ad0d3f${_scopeId}><span data-v-f8ad0d3f${_scopeId}>${ssrInterpolate(allCategoriesSelected.value ? "Deselect all" : "Select all")}</span></div>`);
							else _push(`<!---->`);
							_push(`<div class="multi-select-options" data-v-f8ad0d3f${_scopeId}><!--[-->`);
							ssrRenderList(filteredCategories.value, (category) => {
								_push(`<label class="${ssrRenderClass([{ selected: isCategorySelected(category.id) }, "multi-select-option"])}" data-v-f8ad0d3f${_scopeId}><input type="checkbox"${ssrIncludeBooleanAttr(isCategorySelected(category.id)) ? " checked" : ""} data-v-f8ad0d3f${_scopeId}><span data-v-f8ad0d3f${_scopeId}>${ssrInterpolate(category.name)}</span></label>`);
							});
							_push(`<!--]-->`);
							if (filteredCategories.value.length === 0) _push(`<div class="multi-select-empty" data-v-f8ad0d3f${_scopeId}> No categories found. </div>`);
							else _push(`<!---->`);
							_push(`</div></div>`);
						} else _push(`<!---->`);
						if (unref(form).errors.category_ids) _push(`<p class="ui-field__error" data-v-f8ad0d3f${_scopeId}>${ssrInterpolate(unref(form).errors.category_ids)}</p>`);
						else _push(`<!---->`);
						_push(`</div><div class="multi-select-field" data-v-f8ad0d3f${_scopeId}><label class="ui-label" data-v-f8ad0d3f${_scopeId}> Tags </label><div class="${ssrRenderClass([{ "is-open": tagDropdownOpen.value }, "multi-select-control"])}" data-v-f8ad0d3f${_scopeId}><div class="multi-select-values" data-v-f8ad0d3f${_scopeId}><!--[-->`);
						ssrRenderList(selectedTags.value, (tag) => {
							_push(`<span class="multi-select-chip" data-v-f8ad0d3f${_scopeId}>${ssrInterpolate(tag.name)} <button type="button" class="multi-select-chip-remove" data-v-f8ad0d3f${_scopeId}> × </button></span>`);
						});
						_push(`<!--]-->`);
						if (unref(form).tag_ids.length === 0) _push(`<span class="multi-select-placeholder" data-v-f8ad0d3f${_scopeId}> Select tags </span>`);
						else _push(`<!---->`);
						_push(`</div><span class="multi-select-arrow" data-v-f8ad0d3f${_scopeId}>${ssrInterpolate(tagDropdownOpen.value ? "▲" : "▼")}</span></div>`);
						if (tagDropdownOpen.value) {
							_push(`<div class="multi-select-dropdown" data-v-f8ad0d3f${_scopeId}><div class="multi-select-search-box" data-v-f8ad0d3f${_scopeId}><input${ssrRenderAttr("value", tagSearch.value)} type="text" class="multi-select-search" placeholder="Search tags..." data-v-f8ad0d3f${_scopeId}></div>`);
							if (filteredTags.value.length) _push(`<div class="multi-select-select-all" data-v-f8ad0d3f${_scopeId}><input type="checkbox"${ssrIncludeBooleanAttr(allTagsSelected.value) ? " checked" : ""} data-v-f8ad0d3f${_scopeId}><span data-v-f8ad0d3f${_scopeId}>${ssrInterpolate(allTagsSelected.value ? "Deselect all" : "Select all")}</span></div>`);
							else _push(`<!---->`);
							_push(`<div class="multi-select-options" data-v-f8ad0d3f${_scopeId}><!--[-->`);
							ssrRenderList(filteredTags.value, (tag) => {
								_push(`<label class="${ssrRenderClass([{ selected: isTagSelected(tag.id) }, "multi-select-option"])}" data-v-f8ad0d3f${_scopeId}><input type="checkbox"${ssrIncludeBooleanAttr(isTagSelected(tag.id)) ? " checked" : ""} data-v-f8ad0d3f${_scopeId}><span data-v-f8ad0d3f${_scopeId}>${ssrInterpolate(tag.name)}</span></label>`);
							});
							_push(`<!--]-->`);
							if (filteredTags.value.length === 0) _push(`<div class="multi-select-empty" data-v-f8ad0d3f${_scopeId}> No tags found. </div>`);
							else _push(`<!---->`);
							_push(`</div></div>`);
						} else _push(`<!---->`);
						if (unref(form).errors.tag_ids) _push(`<p class="ui-field__error" data-v-f8ad0d3f${_scopeId}>${ssrInterpolate(unref(form).errors.tag_ids)}</p>`);
						else _push(`<!---->`);
						_push(`</div></div>`);
					} else return [
			...
			_push(ssrRenderComponent(Modal_default, {
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<div class="taxonomy-grid" data-v-f8ad0d3f${_scopeId}><section data-v-f8ad0d3f${_scopeId}><h3 data-v-f8ad0d3f${_scopeId}> Categories </h3><form class="taxonomy-add" data-v-f8ad0d3f${_scopeId}><input${ssrRenderAttr("value", unref(categoryForm).name)} class="ui-input" placeholder="New category name" data-v-f8ad0d3f${_scopeId}><button type="submit" class="ui-btn ui-btn--primary"${ssrIncludeBooleanAttr(unref(categoryForm).processing) ? " disabled" : ""} data-v-f8ad0d3f${_scopeId}>${ssrInterpolate(unref(categoryForm).processing ? "Adding..." : "Add")}</button></form>`);
						if (unref(categoryForm).errors.name) _push(`<p class="ui-field__error" data-v-f8ad0d3f${_scopeId}>${ssrInterpolate(unref(categoryForm).errors.name)}</p>`);
						else _push(`<!---->`);
						_push(`<!--[-->`);
						ssrRenderList(props.categories, (category) => {
							_push(`<div class="taxonomy-row" data-v-f8ad0d3f${_scopeId}><input${ssrRenderAttr("value", categoryEdits.value[category.id])} class="ui-input" data-v-f8ad0d3f${_scopeId}><button type="button" class="ui-btn ui-btn--ghost ui-btn--sm" data-v-f8ad0d3f${_scopeId}> Save </button><button type="button" class="ui-btn ui-btn--danger ui-btn--sm" data-v-f8ad0d3f${_scopeId}> Delete </button></div>`);
						});
						_push(`<!--]--></section><section data-v-f8ad0d3f${_scopeId}><h3 data-v-f8ad0d3f${_scopeId}> Tags </h3><form class="taxonomy-add" data-v-f8ad0d3f${_scopeId}><input${ssrRenderAttr("value", unref(tagForm).name)} class="ui-input" placeholder="New tag name" data-v-f8ad0d3f${_scopeId}><button type="submit" class="ui-btn ui-btn--primary"${ssrIncludeBooleanAttr(unref(tagForm).processing) ? " disabled" : ""} data-v-f8ad0d3f${_scopeId}>${ssrInterpolate(unref(tagForm).processing ? "Adding..." : "Add")}</button></form>`);
						if (unref(tagForm).errors.name) _push(`<p class="ui-field__error" data-v-f8ad0d3f${_scopeId}>${ssrInterpolate(unref(tagForm).errors.name)}</p>`);
						else _push(`<!---->`);
						_push(`<!--[-->`);
						ssrRenderList(props.tags, (tag) => {
							_push(`<div class="taxonomy-row" data-v-f8ad0d3f${_scopeId}><input${ssrRenderAttr("value", tagEdits.value[tag.id])} class="ui-input" data-v-f8ad0d3f${_scopeId}><button type="button" class="ui-btn ui-btn--ghost ui-btn--sm" data-v-f8ad0d3f${_scopeId}> Save </button><button type="button" class="ui-btn ui-btn--danger ui-btn--sm" data-v-f8ad0d3f${_scopeId}> Delete </button></div>`);
						});
						_push(`<!--]--></section></div>`);
...
var Blog_default = /*#__PURE__*/ _plugin_vue_export_helper_default(_sfc_main, [["__scopeId", "data-v-f8ad0d3f"]]);
//#endregion
