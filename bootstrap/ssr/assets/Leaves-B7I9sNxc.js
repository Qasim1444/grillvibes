...
<<<<<<<< HEAD:bootstrap/ssr/assets/Leaves-D8UvL0OT.js
...
>>>>>>>> 92defc434e56ef7274fc5083cb00cd7073d56b27:bootstrap/ssr/assets/Leaves-B7I9sNxc.js
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(ssrRenderComponent(_sfc_main$1, {
				...
				actions: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						if (unref(can)("hr.leaves.create")) _push(`<button class="ui-btn ui-btn--primary" data-v-94ceb162${_scopeId}> + Add Leave </button>`);
						else _push(`<!---->`);
			...
			if (flashError.value) _push(`<div class="ui-alert ui-alert--danger" data-v-94ceb162>${ssrInterpolate(flashError.value)}</div>`);
			else _push(`<!---->`);
			...
			_push(ssrRenderComponent(_sfc_main$2, {
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`<option value="" data-v-94ceb162${_scopeId}>All statuses</option><option value="pending" data-v-94ceb162${_scopeId}>Pending</option><option value="approved" data-v-94ceb162${_scopeId}>Approved</option><option value="rejected" data-v-94ceb162${_scopeId}>Rejected</option>`);
					else return [
			...
			_push(ssrRenderComponent(DataTable_default, {
				...
				"cell:employee_name": withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<div class="lv__name" data-v-94ceb162${_scopeId}><strong data-v-94ceb162${_scopeId}>${ssrInterpolate(row.employee_name)}</strong>`);
						if (row.employee_code) _push(`<span class="lv__code" data-v-94ceb162${_scopeId}>${ssrInterpolate(row.employee_code)}</span>`);
						else _push(`<!---->`);
						_push(`</div>`);
				...
				"cell:leave_type_name": withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) _push(`${ssrInterpolate(row.leave_type_name)} <span class="${ssrRenderClass([row.is_paid ? "ui-badge--success" : "ui-badge--warning", "ui-badge"])}" data-v-94ceb162${_scopeId}>${ssrInterpolate(row.is_paid ? "Paid" : "Unpaid")}</span>`);
				...
				"cell:status": withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<span class="${ssrRenderClass([badgeClass(row.status), "ui-badge"])}" data-v-94ceb162${_scopeId}>${ssrInterpolate(label(row.status))}</span>`);
						if (row.approver_name) _push(`<span class="lv__by" data-v-94ceb162${_scopeId}>by ${ssrInterpolate(row.approver_name)}</span>`);
						else _push(`<!---->`);
				...
				actions: withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) {
						if (unref(can)("hr.leaves.approve")) {
							_push(`<!--[-->`);
							if (row.status !== "approved") _push(`<button class="ui-btn ui-btn--success ui-btn--sm" data-v-94ceb162${_scopeId}> Approve </button>`);
							else _push(`<!---->`);
							if (row.status !== "rejected") _push(`<button class="ui-btn ui-btn--danger ui-btn--sm" data-v-94ceb162${_scopeId}> Reject </button>`);
							else _push(`<!---->`);
							if (row.status !== "pending") _push(`<button class="ui-btn ui-btn--ghost ui-btn--sm" data-v-94ceb162${_scopeId}> Reset </button>`);
							else _push(`<!---->`);
							_push(`<!--]-->`);
						} else _push(`<!---->`);
						if (unref(can)("hr.leaves.update") && row.status === "pending") _push(`<button class="ui-btn ui-btn--ghost ui-btn--sm" data-v-94ceb162${_scopeId}> Edit </button>`);
						else _push(`<!---->`);
						if (unref(can)("hr.leaves.delete")) _push(`<button class="ui-btn ui-btn--danger ui-btn--sm" data-v-94ceb162${_scopeId}> Delete </button>`);
						else _push(`<!---->`);
					} else return [
			...
			_push(ssrRenderComponent(Modal_default, {
				...
				footer: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`<button class="ui-btn ui-btn--ghost" data-v-94ceb162${_scopeId}>Cancel</button><button class="ui-btn ui-btn--primary"${ssrIncludeBooleanAttr(unref(form).processing) ? " disabled" : ""} data-v-94ceb162${_scopeId}>Save</button>`);
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						_push(ssrRenderComponent(_sfc_main$2, {
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) {
									_push(`<option value="" data-v-94ceb162${_scopeId}>— select —</option><!--[-->`);
									ssrRenderList(props.employees, (e) => {
										_push(`<option${ssrRenderAttr("value", e.id)} data-v-94ceb162${_scopeId}>${ssrInterpolate(e.name)}</option>`);
									});
									_push(`<!--]-->`);
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) {
									...
									ssrRenderList(props.leaveTypes, (t) => {
										_push(`<option${ssrRenderAttr("value", t.id)} data-v-94ceb162${_scopeId}>${ssrInterpolate(t.name)} (${ssrInterpolate(t.is_paid ? "paid" : "unpaid")}${ssrInterpolate(t.days_per_year ? `, ${t.days_per_year}/yr` : "")}) </option>`);
									});
									_push(`<!--]-->`);
						...
						_push(`<div class="lv__grid" data-v-94ceb162${_scopeId}>`);
						_push(ssrRenderComponent(_sfc_main$2, {
						...
						_push(`</div>`);
						if (dayCount.value) _push(`<p class="lv__days" data-v-94ceb162${_scopeId}>${ssrInterpolate(dayCount.value)} day${ssrInterpolate(dayCount.value === 1 ? "" : "s")}</p>`);
						else _push(`<!---->`);
						_push(ssrRenderComponent(_sfc_main$2, {
...
var Leaves_default = /*#__PURE__*/ _plugin_vue_export_helper_default(_sfc_main, [["__scopeId", "data-v-94ceb162"]]);
//#endregion
