...
const _sfc_main = /* @__PURE__ */ Object.assign({ layout: AdminLayout }, {
  ...
  setup(__props) {
    ...
    const rows = computed(() => {
      var _a2;
      return ((_a2 = props.campaigns) == null ? void 0 : _a2.data) ?? [];
    });
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1, {
        ...
        actions: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (unref(can)("crm.discounts.create")) {
              _push2(`<button class="ui-btn ui-btn--primary" data-v-e6df504f${_scopeId}> + Add Campaign </button>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
            return [
              unref(can)("crm.discounts.create") ? (openBlock(), createBlock("button", {
                key: 0,
      ...
      if (flashError.value) {
        _push(`<div class="ui-alert ui-alert--danger" data-v-e6df504f>${ssrInterpolate(flashError.value)}</div>`);
      } else {
        _push(`<!---->`);
      }
      ...
      _push(ssrRenderComponent(_sfc_main$2, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<option value="" data-v-e6df504f${_scopeId}>All statuses</option><option value="active" data-v-e6df504f${_scopeId}>Active</option><option value="inactive" data-v-e6df504f${_scopeId}>Inactive</option><option value="expired" data-v-e6df504f${_scopeId}>Expired</option>`);
          } else {
            return [
      ...
      _push(ssrRenderComponent(DataTable, {
        ...
        "cell:name": withCtx(({ row }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="dc__name" data-v-e6df504f${_scopeId}><strong data-v-e6df504f${_scopeId}>${ssrInterpolate(row.name)}</strong><span class="dc__meta" data-v-e6df504f${_scopeId}>priority ${ssrInterpolate(row.priority)}</span></div>`);
          } else {
            return [
              createVNode("div", { class: "dc__name" }, [
                createVNode("strong", null, toDisplayString(row.name), 1),
                createVNode("span", { class: "dc__meta" }, "priority " + toDisplayString(row.priority), 1)
              ])
            ];
          }
        }),
        "cell:value": withCtx(({ row }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span data-v-e6df504f${_scopeId}>${ssrInterpolate(row.type === "percentage" ? `${row.value}%` : money(row.value))}</span>`);
            if (row.max_discount) {
              _push2(`<span class="dc__meta" data-v-e6df504f${_scopeId}>max ${ssrInterpolate(money(row.max_discount))}</span>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
        ...
        "cell:scope": withCtx(({ row }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="dc__scope" data-v-e6df504f${_scopeId}><span class="ui-badge ui-badge--muted" data-v-e6df504f${_scopeId}>${ssrInterpolate(scopeLabel(row.applies_to))}</span>`);
            if (row.target_labels.length) {
              _push2(`<span class="dc__meta" data-v-e6df504f${_scopeId}>${ssrInterpolate(row.target_labels.join(", "))}</span>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div>`);
            ...
            return [
              createVNode("div", { class: "dc__scope" }, [
                createVNode("span", { class: "ui-badge ui-badge--muted" }, toDisplayString(scopeLabel(row.applies_to)), 1),
                row.target_labels.length ? (openBlock(), createBlock("span", {
                  key: 0,
                  class: "dc__meta"
        ...
        "cell:order_types": withCtx(({ value }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`${ssrInterpolate(value.length ? value.map(label).join(", ") : "All types")}`);
          } else {
            return [
              createTextVNode(toDisplayString(value.length ? value.map(label).join(", ") : "All types"), 1)
            ];
          }
        }),
        "cell:window": withCtx(({ row }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="dc__meta" data-v-e6df504f${_scopeId}>${ssrInterpolate(row.starts_at || "—")} → ${ssrInterpolate(row.ends_at || "no end")}</span>`);
          } else {
            return [
              createVNode("span", { class: "dc__meta" }, toDisplayString(row.starts_at || "—") + " → " + toDisplayString(row.ends_at || "no end"), 1)
            ];
          }
        }),
        "cell:is_live": withCtx(({ row }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="${ssrRenderClass([row.is_live ? "ui-badge--success" : "ui-badge--muted", "ui-badge"])}" data-v-e6df504f${_scopeId}>${ssrInterpolate(row.is_live ? "Live" : row.is_active ? "Out of window" : "Off")}</span>`);
          } else {
            return [
              createVNode("span", {
                class: ["ui-badge", row.is_live ? "ui-badge--success" : "ui-badge--muted"]
              }, toDisplayString(row.is_live ? "Live" : row.is_active ? "Out of window" : "Off"), 3)
            ];
          }
        }),
        actions: withCtx(({ row }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (unref(can)("crm.discounts.update")) {
              _push2(`<button class="ui-btn ui-btn--ghost ui-btn--sm" data-v-e6df504f${_scopeId}> Edit </button>`);
            } else {
              _push2(`<!---->`);
            }
            if (unref(can)("crm.discounts.delete")) {
              _push2(`<button class="ui-btn ui-btn--danger ui-btn--sm" data-v-e6df504f${_scopeId}> Delete </button>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
            return [
              unref(can)("crm.discounts.update") ? (openBlock(), createBlock("button", {
                key: 0,
                class: "ui-btn ui-btn--ghost ui-btn--sm",
                onClick: ($event) => editRow(row)
              }, " Edit ", 8, ["onClick"])) : createCommentVNode("", true),
              unref(can)("crm.discounts.delete") ? (openBlock(), createBlock("button", {
                key: 1,
      ...
      _push(ssrRenderComponent(Modal, {
        ...
        footer: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<button class="ui-btn ui-btn--ghost" data-v-e6df504f${_scopeId}>Cancel</button><button class="ui-btn ui-btn--primary"${ssrIncludeBooleanAttr(unref(form).processing) ? " disabled" : ""} data-v-e6df504f${_scopeId}>Save</button>`);
          } else {
            return [
              createVNode("button", {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="dc__grid" data-v-e6df504f${_scopeId}>`);
            ...
            _push2(ssrRenderComponent(_sfc_main$2, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<option${ssrRenderAttr("value", true)} data-v-e6df504f${_scopeId2}>Active</option><option${ssrRenderAttr("value", false)} data-v-e6df504f${_scopeId2}>Inactive</option>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_sfc_main$2, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<option value="fixed" data-v-e6df504f${_scopeId2}>Fixed amount</option><option value="percentage" data-v-e6df504f${_scopeId2}>Percentage</option>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_sfc_main$2, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<option value="all" data-v-e6df504f${_scopeId2}>Whole order</option><option value="category" data-v-e6df504f${_scopeId2}>Selected categories</option><option value="item" data-v-e6df504f${_scopeId2}>Selected items</option>`);
                } else {
                  return [
            ...
            if (unref(form).applies_to !== "all") {
              _push2(`<div class="dc__picker" data-v-e6df504f${_scopeId}><span class="ui-label" data-v-e6df504f${_scopeId}>${ssrInterpolate(unref(form).applies_to === "category" ? "Categories" : "Food items")}</span><div class="dc__chips" data-v-e6df504f${_scopeId}><!--[-->`);
              ssrRenderList(targets.value, (t) => {
                _push2(`<label class="${ssrRenderClass([{ "dc__chip--on": isTarget(t.id) }, "dc__chip"])}" data-v-e6df504f${_scopeId}><input type="checkbox"${ssrIncludeBooleanAttr(isTarget(t.id)) ? " checked" : ""} data-v-e6df504f${_scopeId}> ${ssrInterpolate(t.name)}</label>`);
              });
              _push2(`<!--]--></div>`);
              if (unref(form).errors.target_ids) {
                _push2(`<p class="ui-field__error" data-v-e6df504f${_scopeId}>${ssrInterpolate(unref(form).errors.target_ids)}</p>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div>`);
            ...
            _push2(`<div class="dc__picker" data-v-e6df504f${_scopeId}><span class="ui-label" data-v-e6df504f${_scopeId}>Order types (none ticked = all)</span><div class="dc__chips" data-v-e6df504f${_scopeId}><!--[-->`);
            ssrRenderList(props.orderTypes, (t) => {
              _push2(`<label class="${ssrRenderClass([{ "dc__chip--on": unref(form).order_types.includes(t) }, "dc__chip"])}" data-v-e6df504f${_scopeId}><input type="checkbox"${ssrIncludeBooleanAttr(unref(form).order_types.includes(t)) ? " checked" : ""} data-v-e6df504f${_scopeId}> ${ssrInterpolate(label(t))}</label>`);
            });
            _push2(`<!--]--></div>`);
            if (unref(form).errors.order_types) {
              _push2(`<p class="ui-field__error" data-v-e6df504f${_scopeId}>${ssrInterpolate(unref(form).errors.order_types)}</p>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><p class="dc__note" data-v-e6df504f${_scopeId}> A campaign never rewrites a bill on its own — the cashier confirms it in POS, so the order&#39;s discount stays an explicit decision. </p>`);
          } else {
            return [
              ...
              unref(form).applies_to !== "all" ? (openBlock(), createBlock("div", {
                ...
                createVNode("div", { class: "dc__chips" }, [
                  (openBlock(true), createBlock(Fragment, null, renderList(targets.value, (t) => {
              ...
              createVNode("div", { class: "dc__picker" }, [
                ...
                createVNode("div", { class: "dc__chips" }, [
                  (openBlock(true), createBlock(Fragment, null, renderList(props.orderTypes, (t) => {
                    return openBlock(), createBlock("label", {
                      key: t,
                      ...
                      createTextVNode(" " + toDisplayString(label(t)), 1)
                    ], 2);
                  }), 128))
                ]),
...
const Discounts = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-e6df504f"]]);
export {
  Discounts as default
};
