...
var _sfc_main$2 = {
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			}, "sidebar"])}" data-v-bd184d52><div class="sidebar__brand" data-v-bd184d52><div class="sidebar__logo" data-v-bd184d52>J</div><span class="sidebar__brand-name" data-v-bd184d52>GrillVibes Admin</span></div><nav class="sidebar__nav" data-v-bd184d52><!--[-->`);
			ssrRenderList(visibleGroups.value, (group) => {
				_push(`<!--[--><div class="sidebar__group-title" data-v-bd184d52>${ssrInterpolate(group.title)}</div><!--[-->`);
				ssrRenderList(group.items, (item) => {
					_push(ssrRenderComponent(unref(Link), {
						...
						default: withCtx((_, _push, _parent, _scopeId) => {
							if (_push) _push(`<span class="sidebar__icon" data-v-bd184d52${_scopeId}>${item.icon ?? ""}</span><span class="sidebar__label" data-v-bd184d52${_scopeId}>${ssrInterpolate(item.label)}</span>`);
			...
			_push(`<!--]--></nav></aside>`);
			if (unref(state).mobileOpen) _push(`<div class="sidebar__backdrop" data-v-bd184d52></div>`);
			else _push(`<!---->`);
			_push(`<!--]-->`);
		};
	}
...
var Sidebar_default = /*#__PURE__*/ _plugin_vue_export_helper_default(_sfc_main$2, [["__scopeId", "data-v-bd184d52"]]);
//#endregion
