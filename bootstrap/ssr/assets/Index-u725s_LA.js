		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(ssrRenderComponent(_sfc_main$1, {
				...
				actions: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<a href="/reservations/floor-plan" class="ui-btn ui-btn--ghost" data-v-204afcf2${_scopeId}>🗺 Floor Plan</a>`);
						if (unref(can)("reservations.create")) _push(`<button class="ui-btn ui-btn--secondary" data-v-204afcf2${_scopeId}>+ Waitlist</button>`);
						else _push(`<!---->`);
						if (unref(can)("reservations.create")) _push(`<button class="ui-btn ui-btn--primary" data-v-204afcf2${_scopeId}>+ Reservation</button>`);
						else _push(`<!---->`);
					} else return [
						createVNode("a", {
			...
			if (!props.reservations.length) _push(`<div class="res__empty" data-v-204afcf2>No reservations for this date.</div>`);
			else _push(`<!---->`);
			_push(`<!--[-->`);
			ssrRenderList(props.reservations, (r) => {
				...
				if (r.table_number) _push(`<span data-v-204afcf2>🪑 ${ssrInterpolate(r.table_number)}</span>`);
				else _push(`<!---->`);
				if (r.phone) _push(`<span data-v-204afcf2>📞 ${ssrInterpolate(r.guest_phone)}</span>`);
				else _push(`<!---->`);
				if (r.occasion) _push(`<span data-v-204afcf2>🎉 ${ssrInterpolate(r.occasion)}</span>`);
				else _push(`<!---->`);
				_push(`</div>`);
				if (r.notes) _push(`<div class="res__card-notes" data-v-204afcf2>${ssrInterpolate(r.notes)}</div>`);
				else _push(`<!---->`);
				...
				if (unref(can)("reservations.update")) _push(`<button class="ui-btn ui-btn--ghost ui-btn--sm" data-v-204afcf2>Edit</button>`);
				else _push(`<!---->`);
				if (unref(can)("reservations.delete")) _push(`<button class="ui-btn ui-btn--danger ui-btn--sm" data-v-204afcf2>✕</button>`);
				else _push(`<!---->`);
				_push(`</div></div>`);
			});
			...
			if (!props.waitlist.length) _push(`<div class="res__empty" data-v-204afcf2>Waitlist is empty.</div>`);
			else _push(`<!---->`);
			_push(`<!--[-->`);
			ssrRenderList(props.waitlist, (entry, idx) => {
				...
				if (entry.guest_phone) _push(`<span data-v-204afcf2>📞 ${ssrInterpolate(entry.guest_phone)}</span>`);
				else _push(`<!---->`);
				_push(`<span class="res__wait-time" data-v-204afcf2>⏱ ${ssrInterpolate(entry.wait_minutes)}min waiting</span>`);
				if (entry.estimated_wait_minutes) _push(`<span class="res__wait-est" data-v-204afcf2> Est: ${ssrInterpolate(entry.estimated_wait_minutes)}min </span>`);
				else _push(`<!---->`);
			...
			_push(ssrRenderComponent(Modal_default, {
				...
				footer: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`<button class="ui-btn ui-btn--ghost" data-v-204afcf2${_scopeId}>Cancel</button><button class="ui-btn ui-btn--primary"${ssrIncludeBooleanAttr(unref(form).processing) ? " disabled" : ""} data-v-204afcf2${_scopeId}>Save</button>`);
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<div class="form-grid-2" data-v-204afcf2${_scopeId}>`);
						...
						_push(ssrRenderComponent(_sfc_main$2, {
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) {
									_push(`<option value="" data-v-204afcf2${_scopeId}>— No specific table —</option><!--[-->`);
									ssrRenderList(props.tables, (t) => {
										_push(`<option${ssrRenderAttr("value", t.id)} data-v-204afcf2${_scopeId}>${ssrInterpolate(t.table_number)} (cap. ${ssrInterpolate(t.capacity)}) </option>`);
									});
									_push(`<!--]-->`);
						...
						_push(ssrRenderComponent(_sfc_main$2, {
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) {
									_push(`<option value="" data-v-204afcf2${_scopeId}>Select branch</option><!--[-->`);
									ssrRenderList(props.branches, (b) => {
										_push(`<option${ssrRenderAttr("value", b.id)} data-v-204afcf2${_scopeId}>${ssrInterpolate(b.name)}</option>`);
									});
									_push(`<!--]-->`);
						...
						_push(ssrRenderComponent(_sfc_main$2, {
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) {
									_push(`<!--[-->`);
									ssrRenderList(props.statuses, (s) => {
										_push(`<option${ssrRenderAttr("value", s)} data-v-204afcf2${_scopeId}>${ssrInterpolate(s)}</option>`);
									});
									_push(`<!--]-->`);
			...
			_push(ssrRenderComponent(Modal_default, {
				...
				footer: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`<button class="ui-btn ui-btn--ghost" data-v-204afcf2${_scopeId}>Cancel</button><button class="ui-btn ui-btn--primary"${ssrIncludeBooleanAttr(unref(wlForm).processing) ? " disabled" : ""} data-v-204afcf2${_scopeId}>Add to Waitlist</button>`);
					else return [createVNode("button", {
						class: "ui-btn ui-btn--ghost",
...
var Index_default = /*#__PURE__*/ _plugin_vue_export_helper_default(_sfc_main, [["__scopeId", "data-v-204afcf2"]]);
//#endregion
