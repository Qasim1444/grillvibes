...
var _sfc_main = /*@__PURE__*/ Object.assign({ layout: null }, {
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			if (state.value === "loading") _push(`<div class="qrmenu__screen qrmenu__screen--loading" data-v-6f74139b><div class="qrmenu__loader" data-v-6f74139b><div class="qrmenu__loader-ring" data-v-6f74139b></div></div><h2 data-v-6f74139b>Preparing your menu</h2><p data-v-6f74139b>Please wait a moment...</p></div>`);
			else if (state.value === "error") _push(`<div class="qrmenu__screen qrmenu__screen--error" data-v-6f74139b><div class="qrmenu__error-icon" data-v-6f74139b>!</div><h2 data-v-6f74139b>Menu unavailable</h2><p data-v-6f74139b>${ssrInterpolate(errorMsg.value)}</p><button class="qrmenu__primary-btn" data-v-6f74139b> Try Again </button></div>`);
				...
				if (orderStatus.value) _push(`<div class="qrmenu__status-card" data-v-6f74139b><span class="qrmenu__status-dot" data-v-6f74139b></span><div data-v-6f74139b><small data-v-6f74139b>ORDER STATUS</small><strong data-v-6f74139b>${ssrInterpolate(orderStatus.value)}</strong></div></div>`);
				else _push(`<!---->`);
				...
				_push(`<!--[--><header class="qrmenu__header" data-v-6f74139b><div class="qrmenu__brand" data-v-6f74139b><div class="qrmenu__brand-icon" data-v-6f74139b>${ssrInterpolate(place.value?.name?.charAt(0)?.toUpperCase() || "M")}</div><div class="qrmenu__brand-text" data-v-6f74139b><div class="qrmenu__eyebrow" data-v-6f74139b> WELCOME TO </div><h1 class="qrmenu__title" data-v-6f74139b>${ssrInterpolate(place.value?.name ?? "Restaurant Menu")}</h1>`);
				if (tableInfo.value) _push(`<p class="qrmenu__table" data-v-6f74139b><span class="qrmenu__table-dot" data-v-6f74139b></span> Table ${ssrInterpolate(tableInfo.value.number)}</p>`);
				else _push(`<!---->`);
				_push(`</div></div>`);
				if (cartCount.value) _push(`<button class="qrmenu__header-cart" aria-label="Open cart" data-v-6f74139b><span class="qrmenu__cart-icon" data-v-6f74139b> 🛒 </span><span class="qrmenu__header-cart-count" data-v-6f74139b>${ssrInterpolate(cartCount.value)}</span></button>`);
				else _push(`<!---->`);
				...
				_push(`<!--]--></div></div><main class="qrmenu__content" data-v-6f74139b><div class="qrmenu__section-head" data-v-6f74139b><div data-v-6f74139b><span data-v-6f74139b> MENU </span><h2 data-v-6f74139b>${ssrInterpolate(activeCat.value === null ? "Popular choices" : menu.value.categories.find((c) => c.id === activeCat.value)?.name || "Menu")}</h2></div><span class="qrmenu__item-count" data-v-6f74139b>${ssrInterpolate(filteredItems.value.length)} items </span></div>`);
				if (filteredItems.value.length) {
					...
					ssrRenderList(filteredItems.value, (item) => {
						...
						if (item.image) _push(`<img${ssrRenderAttr("src", item.image)}${ssrRenderAttr("alt", item.name)} loading="lazy" data-v-6f74139b>`);
						else _push(`<div class="qrmenu__item-placeholder" data-v-6f74139b> 🍽️ </div>`);
						if (cartQty(item.id)) _push(`<span class="qrmenu__item-quantity" data-v-6f74139b>${ssrInterpolate(cartQty(item.id))}</span>`);
						else _push(`<!---->`);
						...
						if (item.description) _push(`<p class="qrmenu__item-description" data-v-6f74139b>${ssrInterpolate(item.description)}</p>`);
						else _push(`<!---->`);
					...
					_push(`<!--]--></div>`);
				} else _push(`<div class="qrmenu__empty" data-v-6f74139b><div class="qrmenu__empty-icon" data-v-6f74139b> 🍽️ </div><h3 data-v-6f74139b> No items found </h3><p data-v-6f74139b> There are no menu items in this category. </p></div>`);
				_push(`</main>`);
				if (showCart.value) _push(`<div class="qrmenu__backdrop" data-v-6f74139b></div>`);
				else _push(`<!---->`);
				if (showCart.value) {
					...
					if (config.value.require_name || config.value.require_phone) {
						...
						if (config.value.require_name) _push(`<input${ssrRenderAttr("value", guestName.value)} class="qrmenu__input" placeholder="Your name" type="text" autocomplete="name" data-v-6f74139b>`);
						else _push(`<!---->`);
						if (config.value.require_phone) _push(`<input${ssrRenderAttr("value", guestPhone.value)} class="qrmenu__input" placeholder="Phone number" type="tel" autocomplete="tel" data-v-6f74139b>`);
						else _push(`<!---->`);
						_push(`</div>`);
					} else _push(`<!---->`);
					if (orderError.value) _push(`<p class="qrmenu__order-error" data-v-6f74139b>${ssrInterpolate(orderError.value)}</p>`);
					else _push(`<!---->`);
					...
					if (!placing.value) _push(`<span data-v-6f74139b> → </span>`);
					else _push(`<!---->`);
					_push(`</button></div></aside>`);
				} else _push(`<!---->`);
				if (cartCount.value && !showCart.value) _push(`<button class="qrmenu__fab" data-v-6f74139b><span class="qrmenu__fab-left" data-v-6f74139b><span class="qrmenu__fab-badge" data-v-6f74139b>${ssrInterpolate(cartCount.value)}</span><span data-v-6f74139b> View Order </span></span><span class="qrmenu__fab-total" data-v-6f74139b>${ssrInterpolate(fmt(cartTotal.value))}</span></button>`);
				else _push(`<!---->`);
				_push(`<!--]-->`);
			}
			_push(`</div>`);
...
var QRMenu_default = /*#__PURE__*/ _plugin_vue_export_helper_default(_sfc_main, [["__scopeId", "data-v-6f74139b"]]);
//#endregion
