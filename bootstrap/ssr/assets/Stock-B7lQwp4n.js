...
const _sfc_main = /* @__PURE__ */ Object.assign({ layout: AdminLayout }, {
  ...
  setup(__props) {
    ...
    const levels = computed(() => {
      var _a2;
      return ((_a2 = props.levels) == null ? void 0 : _a2.data) ?? [];
    });
    const search = ref(((_a = props.filters) == null ? void 0 : _a.search) ?? "");
    const viewFilter = ref(((_b = props.filters) == null ? void 0 : _b.view) ?? "");
    let timer = null;
    const reload = () => router.get(
      "/inventory/stock",
      { search: search.value || void 0, view: viewFilter.value || void 0 },
    ...
    const openLedger = async (row) => {
      ...
      try {
        ...
        ledgerError.value = "Could not load the ledger. " + ((e == null ? void 0 : e.message) ?? "");
      } finally {
    ...
    const unitOf = (id) => {
      var _a2;
      return ((_a2 = props.ingredients.find((i) => String(i.id) === String(id))) == null ? void 0 : _a2.unit) ?? "";
    };
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1, {
        ...
        actions: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (unref(can)("inventory.stock.adjust")) {
              _push2(`<button class="ui-btn ui-btn--secondary" data-v-d48bcf9c${_scopeId}> Record Wastage </button>`);
            } else {
              _push2(`<!---->`);
            }
            if (unref(can)("inventory.stock.adjust")) {
              _push2(`<button class="ui-btn ui-btn--primary" data-v-d48bcf9c${_scopeId}> Stock Take </button>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
            return [
              unref(can)("inventory.stock.adjust") ? (openBlock(), createBlock("button", {
                key: 0,
                class: "ui-btn ui-btn--secondary",
                onClick: ($event) => openWriteOff()
              }, " Record Wastage ", 8, ["onClick"])) : createCommentVNode("", true),
              unref(can)("inventory.stock.adjust") ? (openBlock(), createBlock("button", {
                key: 1,
      ...
      _push(ssrRenderComponent(DataTable, {
        ...
        "cell:name": withCtx(({ row }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<strong data-v-d48bcf9c${_scopeId}>${ssrInterpolate(row.name)}</strong>`);
            if (row.sku) {
              _push2(`<span class="st__muted st__code" data-v-d48bcf9c${_scopeId}>${ssrInterpolate(row.sku)}</span>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
        ...
        "cell:quantity": withCtx(({ row }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="${ssrRenderClass(qtyClass(row))}" data-v-d48bcf9c${_scopeId}>${ssrInterpolate(qty(row.quantity))} ${ssrInterpolate(row.unit)}</span>`);
            if (row.quantity < 0) {
              _push2(`<span class="ui-badge ui-badge--danger st__pill" data-v-d48bcf9c${_scopeId}>Negative</span>`);
            } else if (row.needs_reorder) {
              _push2(`<span class="ui-badge ui-badge--warning st__pill" data-v-d48bcf9c${_scopeId}>Reorder</span>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
            return [
              ...
              row.quantity < 0 ? (openBlock(), createBlock("span", {
                key: 0,
        ...
        "cell:reorder_level": withCtx(({ row }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="st__muted" data-v-d48bcf9c${_scopeId}>${ssrInterpolate(qty(row.reorder_level))} ${ssrInterpolate(row.unit)}</span>`);
          } else {
            return [
              createVNode("span", { class: "st__muted" }, toDisplayString(qty(row.reorder_level)) + " " + toDisplayString(row.unit), 1)
            ];
          }
        }),
        "cell:average_cost": withCtx(({ row }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (row.average_cost > 0) {
              _push2(`<span data-v-d48bcf9c${_scopeId}>${ssrInterpolate(fmt(row.average_cost))}<span class="st__muted" data-v-d48bcf9c${_scopeId}> / ${ssrInterpolate(row.unit)}</span></span>`);
            } else {
              _push2(`<span class="st__muted" data-v-d48bcf9c${_scopeId}>—</span>`);
            }
          } else {
            return [
              row.average_cost > 0 ? (openBlock(), createBlock("span", { key: 0 }, [
                createTextVNode(toDisplayString(fmt(row.average_cost)), 1),
                createVNode("span", { class: "st__muted" }, " / " + toDisplayString(row.unit), 1)
        ...
        "cell:stock_value": withCtx(({ value }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<strong data-v-d48bcf9c${_scopeId}>${ssrInterpolate(fmt(value))}</strong>`);
          } else {
            return [
        ...
        actions: withCtx(({ row }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<button class="ui-btn ui-btn--ghost ui-btn--sm" data-v-d48bcf9c${_scopeId}>Ledger</button>`);
            if (unref(can)("inventory.stock.adjust")) {
              _push2(`<button class="ui-btn ui-btn--secondary ui-btn--sm" data-v-d48bcf9c${_scopeId}>Count</button>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
      ...
      if (!props.movements.length) {
        _push(`<p class="st__muted" data-v-d48bcf9c>No stock has moved at this outlet yet.</p>`);
      } else {
        ...
        ssrRenderList(props.movements, (m) => {
          ...
          if (m.note) {
            _push(`<span class="st__note"${ssrRenderAttr("title", m.note)} data-v-d48bcf9c>${ssrInterpolate(m.note)}</span>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</td></tr>`);
      ...
      _push(ssrRenderComponent(Modal, {
        ...
        footer: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<button class="ui-btn ui-btn--ghost" data-v-d48bcf9c${_scopeId}>Cancel</button><button class="ui-btn ui-btn--primary"${ssrIncludeBooleanAttr(unref(countForm).processing) ? " disabled" : ""} data-v-d48bcf9c${_scopeId}>Record Count</button>`);
          } else {
            return [
              createVNode("button", {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<p class="st__hint" data-v-d48bcf9c${_scopeId}> Enter what you physically counted. The system writes the difference to the ledger as an adjustment — it does not create value, so the ingredient keeps its existing average cost. </p>`);
            _push2(ssrRenderComponent(_sfc_main$2, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<option value="" data-v-d48bcf9c${_scopeId2}>Select an ingredient…</option><!--[-->`);
                  ssrRenderList(props.ingredients, (i) => {
                    _push3(`<option${ssrRenderAttr("value", i.id)} data-v-d48bcf9c${_scopeId2}>${ssrInterpolate(i.name)} (${ssrInterpolate(i.unit)})</option>`);
                  });
                  _push3(`<!--]-->`);
                } else {
                  return [
                    createVNode("option", { value: "" }, "Select an ingredient…"),
                    (openBlock(true), createBlock(Fragment, null, renderList(props.ingredients, (i) => {
            ...
            _push2(`<div class="form-grid-2" data-v-d48bcf9c${_scopeId}>`);
            _push2(ssrRenderComponent(_sfc_main$2, {
              ...
              hint: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`In ${ssrInterpolate(unitOf(unref(countForm).ingredient_id) || "the ingredient's unit")}.`);
                } else {
                  return [
                    createTextVNode("In " + toDisplayString(unitOf(unref(countForm).ingredient_id) || "the ingredient's unit") + ".", 1)
                  ];
                }
              }),
              _: 1
            ...
            if (countDelta.value !== null) {
              _push2(`<p class="${ssrRenderClass([countDelta.value === 0 ? "" : countDelta.value > 0 ? "st__in" : "st__out", "st__delta"])}" data-v-d48bcf9c${_scopeId}>`);
              if (countDelta.value === 0) {
                _push2(`<!--[-->Count matches the system balance — nothing will be written.<!--]-->`);
              } else {
                _push2(`<!--[-->Will adjust by ${ssrInterpolate(countDelta.value > 0 ? "+" : "")}${ssrInterpolate(qty(countDelta.value))} ${ssrInterpolate(unitOf(unref(countForm).ingredient_id))}.<!--]-->`);
              }
              _push2(`</p>`);
            } else {
              _push2(`<!---->`);
            ...
            return [
              ...
              countDelta.value !== null ? (openBlock(), createBlock("p", {
                ...
                countDelta.value === 0 ? (openBlock(), createBlock(Fragment, { key: 0 }, [
                  createTextVNode("Count matches the system balance — nothing will be written.")
                ], 64)) : (openBlock(), createBlock(Fragment, { key: 1 }, [
                  createTextVNode("Will adjust by " + toDisplayString(countDelta.value > 0 ? "+" : "") + toDisplayString(qty(countDelta.value)) + " " + toDisplayString(unitOf(unref(countForm).ingredient_id)) + ".", 1)
                ], 64))
      ...
      _push(ssrRenderComponent(Modal, {
        ...
        footer: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<button class="ui-btn ui-btn--ghost" data-v-d48bcf9c${_scopeId}>Cancel</button><button class="ui-btn ui-btn--danger"${ssrIncludeBooleanAttr(unref(wasteForm).processing) ? " disabled" : ""} data-v-d48bcf9c${_scopeId}>Write Off</button>`);
          } else {
            return [
              createVNode("button", {
                class: "ui-btn ui-btn--ghost",
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<p class="st__hint" data-v-d48bcf9c${_scopeId}> Stock that was spoiled, spilled or binned. It leaves at its carrying cost and lands in this month&#39;s wastage figure — use a stock take instead if you are correcting a counting error. </p>`);
            _push2(ssrRenderComponent(_sfc_main$2, {
            ...
            _push2(ssrRenderComponent(_sfc_main$2, {
              ...
              hint: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`In ${ssrInterpolate(unitOf(unref(wasteForm).ingredient_id) || "the ingredient's unit")}.`);
                } else {
                  return [
                    createTextVNode("In " + toDisplayString(unitOf(unref(wasteForm).ingredient_id) || "the ingredient's unit") + ".", 1)
                  ];
                }
              }),
              _: 1
      ...
      _push(ssrRenderComponent(Modal, {
        ...
        footer: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<button class="ui-btn ui-btn--ghost" data-v-d48bcf9c${_scopeId}>Close</button>`);
          } else {
            return [
              createVNode("button", {
                class: "ui-btn ui-btn--ghost",
            ...
            return [
              ledgerLoading.value ? (openBlock(), createBlock("p", {
                ...
                createVNode("tbody", null, [
                  (openBlock(true), createBlock(Fragment, null, renderList(ledger.value, (m) => {
                    return openBlock(), createBlock("tr", {
                      ...
                      createVNode("td", null, [
                        createVNode("span", {
                          class: ["ui-badge", typeBadge(m.type)]
                        }, toDisplayString(typeLabel(m.type)), 3)
                      ]),
                      createVNode("td", {
                        class: ["st__right", m.quantity < 0 ? "st__out" : "st__in"]
                      }, toDisplayString(m.quantity > 0 ? "+" : "") + toDisplayString(qty(m.quantity)), 3),
...
const Stock = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-d48bcf9c"]]);
export {
  Stock as default
};
