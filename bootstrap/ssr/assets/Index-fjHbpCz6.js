...
import { n as usePermissions, t as AdminLayout_default } from "./AdminLayout-Dh9StQaQ.js";
	...
	setup(__props) {
		...
		*/
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<div${ssrRenderAttrs(mergeProps({ class: "page" }, _attrs))} data-v-c1d41a88>`);
			_push(ssrRenderComponent(_sfc_main$1, {
				...
				actions: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<a href="/reservations/floor-plan" class="ui-btn ui-btn--ghost" data-v-c1d41a88${_scopeId}>🗺 Floor Plan</a>`);
						if (unref(can)("reservations.create")) _push(`<button class="ui-btn ui-btn--secondary" data-v-c1d41a88${_scopeId}>+ Waitlist</button>`);
						else _push(`<!---->`);
						if (unref(can)("reservations.create")) _push(`<button class="ui-btn ui-btn--primary" data-v-c1d41a88${_scopeId}>+ Reservation</button>`);
						else _push(`<!---->`);
					} else return [
						createVNode("a", {
			...
			_push(`<div class="res__filters" data-v-c1d41a88><div class="res__filter-group" data-v-c1d41a88><label class="ui-label" data-v-c1d41a88>Date</label><input${ssrRenderAttr("value", dateFilter.value)} type="date" class="ui-input" data-v-c1d41a88></div><div class="res__filter-group" data-v-c1d41a88><label class="ui-label" data-v-c1d41a88>Branch</label><select class="ui-input" style="${ssrRenderStyle({ "width": "180px" })}" data-v-c1d41a88><option value="" data-v-c1d41a88${ssrIncludeBooleanAttr(Array.isArray(branchFilter.value) ? ssrLooseContain(branchFilter.value, "") : ssrLooseEqual(branchFilter.value, "")) ? " selected" : ""}>All Branches</option><!--[-->`);
			ssrRenderList(props.branches, (b) => {
				_push(`<option${ssrRenderAttr("value", b.id)} data-v-c1d41a88${ssrIncludeBooleanAttr(Array.isArray(branchFilter.value) ? ssrLooseContain(branchFilter.value, b.id) : ssrLooseEqual(branchFilter.value, b.id)) ? " selected" : ""}>${ssrInterpolate(b.name)}</option>`);
			});
			_push(`<!--]--></select></div><div class="res__filter-group" data-v-c1d41a88><label class="ui-label" data-v-c1d41a88>Status</label><select class="ui-input" style="${ssrRenderStyle({ "width": "160px" })}" data-v-c1d41a88><option value="" data-v-c1d41a88${ssrIncludeBooleanAttr(Array.isArray(statusFilter.value) ? ssrLooseContain(statusFilter.value, "") : ssrLooseEqual(statusFilter.value, "")) ? " selected" : ""}>All</option><!--[-->`);
			ssrRenderList(props.statuses, (s) => {
				_push(`<option${ssrRenderAttr("value", s)} data-v-c1d41a88${ssrIncludeBooleanAttr(Array.isArray(statusFilter.value) ? ssrLooseContain(statusFilter.value, s) : ssrLooseEqual(statusFilter.value, s)) ? " selected" : ""}>${ssrInterpolate(s)}</option>`);
			});
			_push(`<!--]--></select></div></div><div class="res__grid" data-v-c1d41a88><div class="res__section" data-v-c1d41a88><h3 class="res__section-title" data-v-c1d41a88> Reservations <span class="ui-badge ui-badge--info" data-v-c1d41a88>${ssrInterpolate(props.reservations.length)}</span></h3><div class="res__timeline" data-v-c1d41a88>`);
			if (!props.reservations.length) _push(`<div class="res__empty" data-v-c1d41a88>No reservations for this date.</div>`);
			else _push(`<!---->`);
			_push(`<!--[-->`);
			ssrRenderList(props.reservations, (r) => {
				_push(`<div class="${ssrRenderClass(["res__card--" + r.status, "res__card"])}" data-v-c1d41a88><div class="res__card-time" data-v-c1d41a88><span class="res__time" data-v-c1d41a88>${ssrInterpolate(fmtTime(r.reserved_at))}</span><span class="res__dur" data-v-c1d41a88>${ssrInterpolate(r.duration_minutes)}min</span></div><div class="res__card-body" data-v-c1d41a88><div class="res__card-name" data-v-c1d41a88>${ssrInterpolate(r.guest_name)}</div><div class="res__card-meta" data-v-c1d41a88><span data-v-c1d41a88>👥 ${ssrInterpolate(r.party_size)}</span>`);
				if (r.table_number) _push(`<span data-v-c1d41a88>🪑 ${ssrInterpolate(r.table_number)}</span>`);
				else _push(`<!---->`);
				if (r.phone) _push(`<span data-v-c1d41a88>📞 ${ssrInterpolate(r.guest_phone)}</span>`);
				else _push(`<!---->`);
				if (r.occasion) _push(`<span data-v-c1d41a88>🎉 ${ssrInterpolate(r.occasion)}</span>`);
				else _push(`<!---->`);
				_push(`</div>`);
				if (r.notes) _push(`<div class="res__card-notes" data-v-c1d41a88>${ssrInterpolate(r.notes)}</div>`);
				else _push(`<!---->`);
				_push(`</div><div class="res__card-actions" data-v-c1d41a88><span class="${ssrRenderClass([statusBadge(r.status), "ui-badge"])}" data-v-c1d41a88>${ssrInterpolate(r.status)}</span>`);
				if (unref(can)("reservations.update")) _push(`<button class="ui-btn ui-btn--ghost ui-btn--sm" data-v-c1d41a88>Edit</button>`);
				else _push(`<!---->`);
				if (unref(can)("reservations.delete")) _push(`<button class="ui-btn ui-btn--danger ui-btn--sm" data-v-c1d41a88>✕</button>`);
				else _push(`<!---->`);
				_push(`</div></div>`);
			});
			_push(`<!--]--></div></div><div class="res__section" data-v-c1d41a88><h3 class="res__section-title" data-v-c1d41a88> Waitlist <span class="ui-badge ui-badge--warning" data-v-c1d41a88>${ssrInterpolate(props.waitlist.length)}</span></h3><div class="res__waitlist" data-v-c1d41a88>`);
			if (!props.waitlist.length) _push(`<div class="res__empty" data-v-c1d41a88>Waitlist is empty.</div>`);
			else _push(`<!---->`);
			_push(`<!--[-->`);
			ssrRenderList(props.waitlist, (entry, idx) => {
				_push(`<div class="res__wait-card" data-v-c1d41a88><div class="res__wait-pos" data-v-c1d41a88>${ssrInterpolate(idx + 1)}</div><div class="res__wait-body" data-v-c1d41a88><div class="res__wait-name" data-v-c1d41a88>${ssrInterpolate(entry.guest_name)}</div><div class="res__wait-meta" data-v-c1d41a88><span data-v-c1d41a88>👥 ${ssrInterpolate(entry.party_size)}</span>`);
				if (entry.guest_phone) _push(`<span data-v-c1d41a88>📞 ${ssrInterpolate(entry.guest_phone)}</span>`);
				else _push(`<!---->`);
				_push(`<span class="res__wait-time" data-v-c1d41a88>⏱ ${ssrInterpolate(entry.wait_minutes)}min waiting</span>`);
				if (entry.estimated_wait_minutes) _push(`<span class="res__wait-est" data-v-c1d41a88> Est: ${ssrInterpolate(entry.estimated_wait_minutes)}min </span>`);
				else _push(`<!---->`);
				_push(`</div></div><div class="res__wait-actions" data-v-c1d41a88><button class="ui-btn ui-btn--success ui-btn--sm" data-v-c1d41a88>Seat</button><button class="ui-btn ui-btn--ghost ui-btn--sm" data-v-c1d41a88>Notify</button><button class="ui-btn ui-btn--danger ui-btn--sm" data-v-c1d41a88>✕</button></div></div>`);
			});
			_push(`<!--]--></div></div></div>`);
			_push(ssrRenderComponent(Modal_default, {
				...
				footer: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`<button class="ui-btn ui-btn--ghost" data-v-c1d41a88${_scopeId}>Cancel</button><button class="ui-btn ui-btn--primary"${ssrIncludeBooleanAttr(unref(form).processing) ? " disabled" : ""} data-v-c1d41a88${_scopeId}>Save</button>`);
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<div class="form-grid-2" data-v-c1d41a88${_scopeId}>`);
						...
						_push(ssrRenderComponent(_sfc_main$2, {
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) {
									_push(`<option value="" data-v-c1d41a88${_scopeId}>— No specific table —</option><!--[-->`);
									ssrRenderList(props.tables, (t) => {
										_push(`<option${ssrRenderAttr("value", t.id)} data-v-c1d41a88${_scopeId}>${ssrInterpolate(t.table_number)} (cap. ${ssrInterpolate(t.capacity)}) </option>`);
									});
									_push(`<!--]-->`);
						...
						_push(ssrRenderComponent(_sfc_main$2, {
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) {
									_push(`<option value="" data-v-c1d41a88${_scopeId}>Select branch</option><!--[-->`);
									ssrRenderList(props.branches, (b) => {
										_push(`<option${ssrRenderAttr("value", b.id)} data-v-c1d41a88${_scopeId}>${ssrInterpolate(b.name)}</option>`);
									});
									_push(`<!--]-->`);
						...
						_push(ssrRenderComponent(_sfc_main$2, {
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) {
									_push(`<!--[-->`);
									ssrRenderList(props.statuses, (s) => {
										_push(`<option${ssrRenderAttr("value", s)} data-v-c1d41a88${_scopeId}>${ssrInterpolate(s)}</option>`);
									});
									_push(`<!--]-->`);
			...
			_push(ssrRenderComponent(Modal_default, {
				...
				footer: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`<button class="ui-btn ui-btn--ghost" data-v-c1d41a88${_scopeId}>Cancel</button><button class="ui-btn ui-btn--primary"${ssrIncludeBooleanAttr(unref(wlForm).processing) ? " disabled" : ""} data-v-c1d41a88${_scopeId}>Add to Waitlist</button>`);
					else return [createVNode("button", {
						class: "ui-btn ui-btn--ghost",
...
var Index_default = /*#__PURE__*/ _plugin_vue_export_helper_default(_sfc_main, [["__scopeId", "data-v-c1d41a88"]]);
//#endregion
