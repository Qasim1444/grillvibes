...
<<<<<<<< HEAD:bootstrap/ssr/assets/Orders-BvVavbXY.js
...
>>>>>>>> 92defc434e56ef7274fc5083cb00cd7073d56b27:bootstrap/ssr/assets/Orders-BPiWhs6Z.js
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(ssrRenderComponent(_sfc_main$1, {
				...
				actions: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<button class="ui-btn ui-btn--ghost" data-v-b25be85d${_scopeId}>Refresh</button>`);
			...
			if (flashError.value) _push(`<div class="ui-alert ui-alert--danger" data-v-b25be85d>${ssrInterpolate(flashError.value)}</div>`);
			else _push(`<!---->`);
			...
			_push(ssrRenderComponent(DataTable_default, {
				...
				"cell:status": withCtx(({ value }, _push, _parent, _scopeId) => {
					if (_push) _push(`<span class="${ssrRenderClass([statusClass(value), "ui-badge"])}" data-v-b25be85d${_scopeId}>${ssrInterpolate(value || "—")}</span>`);
				...
				"cell:paid": withCtx(({ value }, _push, _parent, _scopeId) => {
					if (_push) _push(`<span class="${ssrRenderClass([value ? "ui-badge--success" : "ui-badge--muted", "ui-badge"])}" data-v-b25be85d${_scopeId}>${ssrInterpolate(value ? "Paid" : "Unpaid")}</span>`);
				...
				actions: withCtx(({ row }, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<button class="ui-btn ui-btn--ghost ui-btn--sm" data-v-b25be85d${_scopeId}>View</button>`);
						if (unref(can)("orders.update")) _push(`<button class="ui-btn ui-btn--ghost ui-btn--sm" data-v-b25be85d${_scopeId}>Edit</button>`);
						else _push(`<!---->`);
						if (unref(can)("orders.delete")) _push(`<button class="ui-btn ui-btn--danger ui-btn--sm" data-v-b25be85d${_scopeId}>Delete</button>`);
						else _push(`<!---->`);
					} else return [
						createVNode("button", {
			...
			_push(ssrRenderComponent(Modal_default, {
				...
				footer: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<button class="ui-btn ui-btn--ghost" data-v-b25be85d${_scopeId}>Close</button>`);
						if (unref(can)("orders.update")) _push(`<button class="ui-btn ui-btn--primary" data-v-b25be85d${_scopeId}>Edit</button>`);
						else _push(`<!---->`);
					} else return [createVNode("button", {
						class: "ui-btn ui-btn--ghost",
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						if (viewing.value) {
							_push(`<div data-v-b25be85d${_scopeId}><div class="ord-meta" data-v-b25be85d${_scopeId}><div data-v-b25be85d${_scopeId}><span data-v-b25be85d${_scopeId}>Customer</span><strong data-v-b25be85d${_scopeId}>${ssrInterpolate(viewing.value.customer?.name || "Guest")}</strong></div><div data-v-b25be85d${_scopeId}><span data-v-b25be85d${_scopeId}>Type</span><strong data-v-b25be85d${_scopeId}>${ssrInterpolate(typeLabel(viewing.value.type))}</strong></div><div data-v-b25be85d${_scopeId}><span data-v-b25be85d${_scopeId}>Status</span><strong data-v-b25be85d${_scopeId}>${ssrInterpolate(viewing.value.status || "—")}</strong></div><div data-v-b25be85d${_scopeId}><span data-v-b25be85d${_scopeId}>Paid</span><strong data-v-b25be85d${_scopeId}>${ssrInterpolate(viewing.value.paid ? "Yes" : "No")}</strong></div><div data-v-b25be85d${_scopeId}><span data-v-b25be85d${_scopeId}>Place</span><strong data-v-b25be85d${_scopeId}>${ssrInterpolate(placeName(viewing.value.place_id))}</strong></div><div data-v-b25be85d${_scopeId}><span data-v-b25be85d${_scopeId}>Placed</span><strong data-v-b25be85d${_scopeId}>${ssrInterpolate(dateTime(viewing.value.order_datetime))}</strong></div></div><table class="data-table ord-items" data-v-b25be85d${_scopeId}><thead data-v-b25be85d${_scopeId}><tr data-v-b25be85d${_scopeId}><th data-v-b25be85d${_scopeId}>Item</th><th style="${ssrRenderStyle({ "text-align": "center" })}" data-v-b25be85d${_scopeId}>Qty</th><th style="${ssrRenderStyle({ "text-align": "right" })}" data-v-b25be85d${_scopeId}>Subtotal</th></tr></thead><tbody data-v-b25be85d${_scopeId}>`);
							if (!(viewing.value.order_items || []).length) _push(`<tr data-v-b25be85d${_scopeId}><td colspan="3" class="data-table__empty" data-v-b25be85d${_scopeId}>No items on this order.</td></tr>`);
							else _push(`<!---->`);
							_push(`<!--[-->`);
							ssrRenderList(viewing.value.order_items || [], (it) => {
								_push(`<tr data-v-b25be85d${_scopeId}><td data-v-b25be85d${_scopeId}>${ssrInterpolate(itemName(it.fooditems_id))} `);
								if (it.add_note) _push(`<small class="ord-note" data-v-b25be85d${_scopeId}>${ssrInterpolate(it.add_note)}</small>`);
								else _push(`<!---->`);
								_push(`</td><td style="${ssrRenderStyle({ "text-align": "center" })}" data-v-b25be85d${_scopeId}>${ssrInterpolate(it.quantity)}</td><td style="${ssrRenderStyle({ "text-align": "right" })}" data-v-b25be85d${_scopeId}>${ssrInterpolate(money(it.sub_total))}</td></tr>`);
							});
							_push(`<!--]--></tbody></table><div class="ord-totals" data-v-b25be85d${_scopeId}><div data-v-b25be85d${_scopeId}><span data-v-b25be85d${_scopeId}>Subtotal</span><span data-v-b25be85d${_scopeId}>${ssrInterpolate(money(viewing.value.subtotal))}</span></div><div data-v-b25be85d${_scopeId}><span data-v-b25be85d${_scopeId}>Discount (${ssrInterpolate(viewing.value.discount_type)})</span><span data-v-b25be85d${_scopeId}>− ${ssrInterpolate(money(viewing.value.discount_amount))}</span></div>`);
							if (num(viewing.value.promo_discount) > 0) _push(`<div data-v-b25be85d${_scopeId}><span data-v-b25be85d${_scopeId}>Promo · ${ssrInterpolate(viewing.value.promo_code?.code ?? "code")}</span><span data-v-b25be85d${_scopeId}>− ${ssrInterpolate(money(viewing.value.promo_discount))}</span></div>`);
							else _push(`<!---->`);
							if (num(viewing.value.loyalty_discount) > 0) _push(`<div data-v-b25be85d${_scopeId}><span data-v-b25be85d${_scopeId}>Points redeemed · ${ssrInterpolate(viewing.value.loyalty_points_redeemed)}</span><span data-v-b25be85d${_scopeId}>− ${ssrInterpolate(money(viewing.value.loyalty_discount))}</span></div>`);
							else _push(`<!---->`);
							_push(`<div data-v-b25be85d${_scopeId}><span data-v-b25be85d${_scopeId}>Service charge (${ssrInterpolate(viewing.value.service_charges_percentage)}%)</span><span data-v-b25be85d${_scopeId}>+ ${ssrInterpolate(money(viewing.value.service_charges))}</span></div><div class="ord-totals__grand" data-v-b25be85d${_scopeId}><span data-v-b25be85d${_scopeId}>Grand Total</span><span data-v-b25be85d${_scopeId}>${ssrInterpolate(money(viewing.value.grand_total))}</span></div>`);
							if (num(viewing.value.loyalty_points_earned) > 0) _push(`<p class="ord-totals__note ord-totals__note--ok" data-v-b25be85d${_scopeId}> Earned ${ssrInterpolate(viewing.value.loyalty_points_earned)} loyalty point(s). </p>`);
							else _push(`<!---->`);
							_push(`</div></div>`);
						} else _push(`<!---->`);
			...
			_push(ssrRenderComponent(Modal_default, {
				...
				footer: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`<button class="ui-btn ui-btn--ghost" data-v-b25be85d${_scopeId}>Cancel</button><button class="ui-btn ui-btn--primary"${ssrIncludeBooleanAttr(saving.value) ? " disabled" : ""} data-v-b25be85d${_scopeId}>${ssrInterpolate(saving.value ? "Saving…" : "Save Changes")}</button>`);
					else return [createVNode("button", {
						class: "ui-btn ui-btn--ghost",
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						if (saveError.value) _push(`<div class="ui-alert ui-alert--danger" data-v-b25be85d${_scopeId}>${ssrInterpolate(saveError.value)}</div>`);
						else _push(`<!---->`);
						_push(`<div class="ord-fields" data-v-b25be85d${_scopeId}>`);
						_push(ssrRenderComponent(_sfc_main$2, {
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) _push(`<option value="dining" data-v-b25be85d${_scopeId}>Dining</option><option value="delivery" data-v-b25be85d${_scopeId}>Delivery</option><option value="on-way" data-v-b25be85d${_scopeId}>On the way</option>`);
								else return [
						...
						_push(ssrRenderComponent(_sfc_main$2, {
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) _push(`<option value="pending" data-v-b25be85d${_scopeId}>Pending</option><option value="preparing" data-v-b25be85d${_scopeId}>Preparing</option><option value="on-way" data-v-b25be85d${_scopeId}>On the way</option><option value="completed" data-v-b25be85d${_scopeId}>Completed</option>`);
								else return [
						...
						_push(ssrRenderComponent(_sfc_main$2, {
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) {
									_push(`<option value="" data-v-b25be85d${_scopeId}>— Select place —</option><!--[-->`);
									ssrRenderList(places.value, (p) => {
										_push(`<option${ssrRenderAttr("value", p.id)} data-v-b25be85d${_scopeId}>${ssrInterpolate(p.name)}</option>`);
									});
									_push(`<!--]-->`);
						...
						_push(ssrRenderComponent(_sfc_main$2, {
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) _push(`<option value="amount" data-v-b25be85d${_scopeId}>Amount</option><option value="percentage" data-v-b25be85d${_scopeId}>Percentage</option>`);
						...
						_push(ssrRenderComponent(_sfc_main$2, {
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) _push(`<option${ssrRenderAttr("value", true)} data-v-b25be85d${_scopeId}>Yes</option><option${ssrRenderAttr("value", false)} data-v-b25be85d${_scopeId}>No</option>`);
								else return [createVNode("option", { value: true }, "Yes"), createVNode("option", { value: false }, "No")];
							}),
							_: 1
						}, _parent, _scopeId));
						_push(`</div><div class="ord-lines" data-v-b25be85d${_scopeId}><div class="ord-lines__title" data-v-b25be85d${_scopeId}>Items</div>`);
						if (!form.value.items.length) _push(`<p class="ord-hint" data-v-b25be85d${_scopeId}> This order has no items. Add at least one before saving. </p>`);
						else _push(`<!---->`);
						_push(`<!--[-->`);
						ssrRenderList(form.value.items, (line) => {
							_push(`<div class="ord-line" data-v-b25be85d${_scopeId}><span class="ord-line__name" data-v-b25be85d${_scopeId}>${ssrInterpolate(line.name)}</span><div class="ord-qty" data-v-b25be85d${_scopeId}><button type="button" aria-label="Decrease quantity" data-v-b25be85d${_scopeId}>−</button><span data-v-b25be85d${_scopeId}>${ssrInterpolate(line.quantity)}</span><button type="button" aria-label="Increase quantity" data-v-b25be85d${_scopeId}>+</button></div><span class="ord-line__sub" data-v-b25be85d${_scopeId}>${ssrInterpolate(money(lineTotal(line)))}</span><button class="ord-line__x" type="button"${ssrRenderAttr("aria-label", `Remove ${line.name}`)} data-v-b25be85d${_scopeId}> × </button></div>`);
						});
						_push(`<!--]--><div class="ord-add" data-v-b25be85d${_scopeId}><select class="ui-select" aria-label="Add item to order" data-v-b25be85d${_scopeId}><option value="" data-v-b25be85d${ssrIncludeBooleanAttr(Array.isArray(addItemId.value) ? ssrLooseContain(addItemId.value, "") : ssrLooseEqual(addItemId.value, "")) ? " selected" : ""}${_scopeId}>+ Add item…</option><!--[-->`);
						ssrRenderList(items.value, (i) => {
							_push(`<option${ssrRenderAttr("value", i.id)} data-v-b25be85d${ssrIncludeBooleanAttr(Array.isArray(addItemId.value) ? ssrLooseContain(addItemId.value, i.id) : ssrLooseEqual(addItemId.value, i.id)) ? " selected" : ""}${_scopeId}>${ssrInterpolate(i.name)} — ${ssrInterpolate(money(i.price))}</option>`);
						});
						_push(`<!--]--></select><button class="ui-btn ui-btn--ghost ui-btn--sm"${ssrIncludeBooleanAttr(!addItemId.value) ? " disabled" : ""} data-v-b25be85d${_scopeId}> Add </button></div></div>`);
						if (form.value.promo_code || num(form.value.redeem_points) > 0) {
							_push(`<div class="ord-crm" data-v-b25be85d${_scopeId}>`);
							if (form.value.promo_code) _push(`<div class="ord-crm__row" data-v-b25be85d${_scopeId}><span data-v-b25be85d${_scopeId}>Promo <strong data-v-b25be85d${_scopeId}>${ssrInterpolate(form.value.promo_code)}</strong> stays applied and is re-priced on save.</span><button class="ui-btn ui-btn--ghost ui-btn--sm" data-v-b25be85d${_scopeId}>Remove</button></div>`);
							else _push(`<!---->`);
							if (num(form.value.redeem_points) > 0) _push(`<div class="ord-crm__row" data-v-b25be85d${_scopeId}><span data-v-b25be85d${_scopeId}><strong data-v-b25be85d${_scopeId}>${ssrInterpolate(form.value.redeem_points)}</strong> point(s) stay redeemed against this order.</span><button class="ui-btn ui-btn--ghost ui-btn--sm" data-v-b25be85d${_scopeId}>Refund</button></div>`);
							else _push(`<!---->`);
							_push(`</div>`);
						} else _push(`<!---->`);
						_push(`<div class="ord-totals" data-v-b25be85d${_scopeId}><div data-v-b25be85d${_scopeId}><span data-v-b25be85d${_scopeId}>Subtotal</span><span data-v-b25be85d${_scopeId}>${ssrInterpolate(money(subtotal.value))}</span></div><div data-v-b25be85d${_scopeId}><span data-v-b25be85d${_scopeId}>Discount</span><span data-v-b25be85d${_scopeId}>− ${ssrInterpolate(money(discountValue.value))}</span></div><div data-v-b25be85d${_scopeId}><span data-v-b25be85d${_scopeId}>Service charge</span><span data-v-b25be85d${_scopeId}>+ ${ssrInterpolate(money(serviceCharges.value))}</span></div><div class="ord-totals__grand" data-v-b25be85d${_scopeId}><span data-v-b25be85d${_scopeId}>Grand Total</span><span data-v-b25be85d${_scopeId}>${ssrInterpolate(money(grandTotal.value))}</span></div>`);
						if (form.value.promo_code || num(form.value.redeem_points) > 0) _push(`<p class="ord-totals__note" data-v-b25be85d${_scopeId}> The promo and points discounts are added by the server, so the saved total lands below this figure. </p>`);
						else _push(`<!---->`);
						_push(`</div>`);
					} else return [
...
var Orders_default = /*#__PURE__*/ _plugin_vue_export_helper_default(_sfc_main, [["__scopeId", "data-v-b25be85d"]]);
//#endregion
