...
var _sfc_main$2 = {
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			}, "sidebar"])}" data-v-f2892f83><div class="sidebar__brand" data-v-f2892f83><div class="sidebar__logo" data-v-f2892f83>J</div><span class="sidebar__brand-name" data-v-f2892f83>KitchenOS Admin</span></div><nav class="sidebar__nav" data-v-f2892f83><!--[-->`);
			ssrRenderList(visibleGroups.value, (group) => {
				_push(`<!--[--><div class="sidebar__group-title" data-v-f2892f83>${ssrInterpolate(group.title)}</div><!--[-->`);
				ssrRenderList(group.items, (item) => {
					_push(ssrRenderComponent(unref(Link), {
						...
						default: withCtx((_, _push, _parent, _scopeId) => {
							if (_push) _push(`<span class="sidebar__icon" data-v-f2892f83${_scopeId}>${item.icon ?? ""}</span><span class="sidebar__label" data-v-f2892f83${_scopeId}>${ssrInterpolate(item.label)}</span>`);
			...
			_push(`<!--]--></nav></aside>`);
			if (unref(state).mobileOpen) _push(`<div class="sidebar__backdrop" data-v-f2892f83></div>`);
			else _push(`<!---->`);
			_push(`<!--]-->`);
		};
	}
...
var Sidebar_default = /*#__PURE__*/ _plugin_vue_export_helper_default(_sfc_main$2, [["__scopeId", "data-v-f2892f83"]]);
//#endregion
			...
			if (branches.value.length) {
				...
				if (branchMenuOpen.value) {
					...
					ssrRenderList(branches.value, (b) => {
						...
						if (b.id === currentBranchId.value) _push(`<svg viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" data-v-7953cf89><path d="M20 6 9 17l-5-5" data-v-7953cf89></path></svg>`);
						else _push(`<!---->`);
						_push(`</button>`);
					});
					_push(`<!--]--></div>`);
...
var Topbar_default = /*#__PURE__*/ _plugin_vue_export_helper_default(_sfc_main$1, [["__scopeId", "data-v-7953cf89"]]);
//#endregion
