import { ref, watch, mergeProps, unref, withCtx, createTextVNode, toDisplayString, openBlock, createBlock, createCommentVNode, Fragment, createVNode, useSSRContext } from "vue";
...
const _sfc_main = /* @__PURE__ */ Object.assign({ layout: AdminLayout }, {
  ...
  setup(__props) {
    ...
    const from = ref(((_a = props.filters) == null ? void 0 : _a.from) ?? "");
    const to = ref(((_b = props.filters) == null ? void 0 : _b.to) ?? "");
    const categoryFilter = ref(((_c = props.filters) == null ? void 0 : _c.category) ?? "");
    const sort = ref(((_d = props.filters) == null ? void 0 : _d.sort) ?? "revenue");
    let timer = null;
    ...
    watch([from, to, categoryFilter, sort], () => {
      clearTimeout(timer);
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (props.orders.uncosted_orders > 0 || props.totals.understating > 0) {
        ...
        if (props.orders.uncosted_orders > 0) {
          _push(`<p class="fc__warning" data-v-7abfb395><strong data-v-7abfb395>${ssrInterpolate(props.orders.uncosted_orders)}</strong> of ${ssrInterpolate(props.orders.orders)} order(s) in this period were never costed — placed before their dishes had recipes, or reversed since. COGS above is a floor, not the full figure. </p>`);
        } else {
          _push(`<!---->`);
        }
        if (props.totals.understating > 0) {
          ...
          _push(ssrRenderComponent(unref(Link), {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`Add their recipes`);
              } else {
                return [
                  createTextVNode("Add their recipes")
                ];
              }
            }),
            _: 1
      ...
      _push(ssrRenderComponent(DataTable, {
        ...
        "cell:name": withCtx(({ row }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<strong data-v-7abfb395${_scopeId}>${ssrInterpolate(row.name)}</strong><span class="fc__cat" data-v-7abfb395${_scopeId}>${ssrInterpolate(row.category_name || "Uncategorised")}</span>`);
          } else {
            return [
              createVNode("strong", null, toDisplayString(row.name), 1),
              createVNode("span", { class: "fc__cat" }, toDisplayString(row.category_name || "Uncategorised"), 1)
            ];
          }
        }),
        ...
        "cell:dish_cost": withCtx(({ row }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (!row.has_recipe) {
              _push2(`<span class="ui-badge ui-badge--muted" data-v-7abfb395${_scopeId}>No recipe</span>`);
            } else {
              _push2(`<span data-v-7abfb395${_scopeId}>${ssrInterpolate(fmt(row.dish_cost))}</span>`);
            }
          } else {
            return [
              !row.has_recipe ? (openBlock(), createBlock("span", {
                key: 0,
        ...
        "cell:food_cost_percent": withCtx(({ row }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (row.food_cost_percent === null) {
              _push2(`<span class="fc__muted" data-v-7abfb395${_scopeId}>—</span>`);
            } else {
              _push2(`<span class="${ssrRenderClass([pctBadge(row.food_cost_percent), "ui-badge"])}" data-v-7abfb395${_scopeId}>${ssrInterpolate(row.food_cost_percent)}%</span>`);
            }
          } else {
            return [
        ...
        "cell:margin": withCtx(({ row }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (row.margin === null) {
              ...
              _push2(`<span class="${ssrRenderClass(row.margin < 0 ? "fc__neg" : "")}" data-v-7abfb395${_scopeId}>${ssrInterpolate(fmt(row.margin))}</span>`);
            }
          } else {
            return [
        ...
        "cell:units_sold": withCtx(({ row }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (row.units_sold > 0) {
              _push2(`<span data-v-7abfb395${_scopeId}>${ssrInterpolate(qty(row.units_sold))}</span>`);
            } else {
              _push2(`<span class="fc__muted" data-v-7abfb395${_scopeId}>—</span>`);
            }
          } else {
            return [
              row.units_sold > 0 ? (openBlock(), createBlock("span", { key: 0 }, toDisplayString(qty(row.units_sold)), 1)) : (openBlock(), createBlock("span", {
                key: 1,
                class: "fc__muted"
              }, "—"))
            ];
        ...
        "cell:revenue": withCtx(({ row }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (row.units_sold > 0) {
              _push2(`<span data-v-7abfb395${_scopeId}>${ssrInterpolate(fmt(row.revenue))}</span>`);
            } else {
              _push2(`<span class="fc__muted" data-v-7abfb395${_scopeId}>—</span>`);
            }
          } else {
            return [
              row.units_sold > 0 ? (openBlock(), createBlock("span", { key: 0 }, toDisplayString(fmt(row.revenue)), 1)) : (openBlock(), createBlock("span", {
                key: 1,
                class: "fc__muted"
              }, "—"))
            ];
        ...
        "cell:cogs": withCtx(({ row }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (row.understates_cogs) {
              _push2(`<span class="fc__muted" title="Sold with no recipe, so no cost was recorded." data-v-7abfb395${_scopeId}> not costed </span>`);
            } else if (row.units_sold > 0) {
              _push2(`<span data-v-7abfb395${_scopeId}>${ssrInterpolate(fmt(row.cogs))}</span>`);
            } else {
              _push2(`<span class="fc__muted" data-v-7abfb395${_scopeId}>—</span>`);
            }
          } else {
            return [
              row.understates_cogs ? (openBlock(), createBlock("span", {
                key: 0,
                class: "fc__muted",
        ...
        "cell:gross_profit": withCtx(({ row }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (row.units_sold > 0) {
              _push2(`<!--[--><strong class="${ssrRenderClass(row.gross_profit < 0 ? "fc__neg" : "")}" data-v-7abfb395${_scopeId}>${ssrInterpolate(fmt(row.gross_profit))}</strong>`);
              if (row.gross_margin_percent !== null) {
                _push2(`<span class="fc__cat" data-v-7abfb395${_scopeId}>${ssrInterpolate(row.gross_margin_percent)}% margin</span>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`<!--]-->`);
            ...
            return [
              row.units_sold > 0 ? (openBlock(), createBlock(Fragment, { key: 0 }, [
                createVNode("strong", {
                  class: row.gross_profit < 0 ? "fc__neg" : ""
                }, toDisplayString(fmt(row.gross_profit)), 3),
                row.gross_margin_percent !== null ? (openBlock(), createBlock("span", {
                  key: 0,
                  class: "fc__cat"
                }, toDisplayString(row.gross_margin_percent) + "% margin", 1)) : createCommentVNode("", true)
            ...
            if (unref(can)("inventory.recipes.view")) {
              _push2(ssrRenderComponent(unref(Link), {
                ...
                default: withCtx((_, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`${ssrInterpolate(row.has_recipe ? "Recipe" : "Add Recipe")}`);
                  } else {
                    return [
                      createTextVNode(toDisplayString(row.has_recipe ? "Recipe" : "Add Recipe"), 1)
                    ];
                  }
                }),
                _: 2
...
const FoodCost = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-7abfb395"]]);
export {
  FoodCost as default
};
