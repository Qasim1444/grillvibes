...
import { Fragment, createBlock, createCommentVNode, createVNode, mergeProps, openBlock, ref, renderList, toDisplayString, unref, useSSRContext, vModelSelect, withCtx, withDirectives } from "vue";
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(ssrRenderComponent(_sfc_main$1, {
				...
				actions: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<select class="ui-input" style="${ssrRenderStyle({ "width": "180px" })}" data-v-1f56ffac${_scopeId}><option value="" data-v-1f56ffac${ssrIncludeBooleanAttr(Array.isArray(selectedBranch.value) ? ssrLooseContain(selectedBranch.value, "") : ssrLooseEqual(selectedBranch.value, "")) ? " selected" : ""}${_scopeId}>All Branches</option><!--[-->`);
						ssrRenderList(props.branches, (b) => {
							_push(`<option${ssrRenderAttr("value", b.id)} data-v-1f56ffac${ssrIncludeBooleanAttr(Array.isArray(selectedBranch.value) ? ssrLooseContain(selectedBranch.value, b.id) : ssrLooseEqual(selectedBranch.value, b.id)) ? " selected" : ""}${_scopeId}>${ssrInterpolate(b.name)}</option>`);
						});
						_push(`<!--]--></select><button class="ui-btn ui-btn--ghost"${ssrIncludeBooleanAttr(saving.value) ? " disabled" : ""} data-v-1f56ffac${_scopeId}>${ssrInterpolate(saving.value ? "Saving…" : "💾 Save Layout")}</button>`);
						if (unref(can)("reservations.update")) _push(`<button class="ui-btn ui-btn--primary" data-v-1f56ffac${_scopeId}>+ Add Table</button>`);
						else _push(`<!---->`);
					} else return [
			...
			ssrRenderList(tables.value, (table) => {
				...
				], "fp__table"])}" style="${ssrRenderStyle(tableStyle(table))}" data-v-1f56ffac><span class="fp__table-num" data-v-1f56ffac>${ssrInterpolate(table.table_number)}</span><span class="fp__table-cap" data-v-1f56ffac>${ssrInterpolate(table.capacity)}p</span>`);
				if (table.current_order_type) _push(`<span class="fp__table-order" data-v-1f56ffac>${ssrInterpolate(typeEmoji(table.current_order_type))}</span>`);
				else _push(`<!---->`);
				_push(`</div>`);
			});
			_push(`<!--]--></div>`);
			if (selected.value) {
				_push(`<div class="fp__drawer" data-v-1f56ffac><div class="fp__drawer-hdr" data-v-1f56ffac><span data-v-1f56ffac>Table ${ssrInterpolate(selected.value.table_number)}</span><button class="fp__drawer-close" data-v-1f56ffac>✕</button></div><div class="fp__drawer-body" data-v-1f56ffac><p data-v-1f56ffac><strong data-v-1f56ffac>Capacity:</strong> ${ssrInterpolate(selected.value.capacity)}</p><p data-v-1f56ffac><strong data-v-1f56ffac>Status:</strong><select class="ui-input" style="${ssrRenderStyle({
					"width": "140px",
					"margin-left": "8px"
				})}" data-v-1f56ffac><!--[-->`);
				...
				_push(`<!--]--></select></p>`);
				if (selected.value.current_order_type) _push(`<p data-v-1f56ffac><strong data-v-1f56ffac>Order:</strong> ${ssrInterpolate(typeLabel(selected.value.current_order_type))}</p>`);
				else _push(`<!---->`);
			...
			_push(ssrRenderComponent(Modal_default, {
				...
				footer: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`<button class="ui-btn ui-btn--ghost" data-v-1f56ffac${_scopeId}>Cancel</button><button class="ui-btn ui-btn--primary"${ssrIncludeBooleanAttr(unref(tableForm).processing) ? " disabled" : ""} data-v-1f56ffac${_scopeId}>Save</button>`);
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<div class="form-grid-2" data-v-1f56ffac${_scopeId}>`);
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) {
									...
									ssrRenderList(props.tableShapes, (s) => {
										_push(`<option${ssrRenderAttr("value", s)} data-v-1f56ffac${_scopeId}>${ssrInterpolate(s)}</option>`);
									});
									_push(`<!--]-->`);
						...
						_push(ssrRenderComponent(_sfc_main$2, {
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) {
									_push(`<option value="" data-v-1f56ffac${_scopeId}>Select branch</option><!--[-->`);
									ssrRenderList(props.branches, (b) => {
										_push(`<option${ssrRenderAttr("value", b.id)} data-v-1f56ffac${_scopeId}>${ssrInterpolate(b.name)}</option>`);
									});
									_push(`<!--]-->`);
...
var FloorPlan_default = /*#__PURE__*/ _plugin_vue_export_helper_default(_sfc_main, [["__scopeId", "data-v-1f56ffac"]]);
//#endregion
