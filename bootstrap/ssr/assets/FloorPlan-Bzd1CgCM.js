...
<<<<<<<< HEAD:bootstrap/ssr/assets/FloorPlan-BkyCUZxg.js
...
>>>>>>>> 92defc434e56ef7274fc5083cb00cd7073d56b27:bootstrap/ssr/assets/FloorPlan-Bzd1CgCM.js
...
var _sfc_main = /*@__PURE__*/ Object.assign({ layout: AdminLayout_default }, {
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<div${ssrRenderAttrs(mergeProps({ class: "page" }, _attrs))} data-v-fea59dc5>`);
			_push(ssrRenderComponent(_sfc_main$1, {
				...
				actions: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<select class="ui-input" style="${ssrRenderStyle({ "width": "180px" })}" data-v-fea59dc5${_scopeId}><option value="" data-v-fea59dc5${ssrIncludeBooleanAttr(Array.isArray(selectedBranch.value) ? ssrLooseContain(selectedBranch.value, "") : ssrLooseEqual(selectedBranch.value, "")) ? " selected" : ""}${_scopeId}>All Branches</option><!--[-->`);
						ssrRenderList(props.branches, (b) => {
							_push(`<option${ssrRenderAttr("value", b.id)} data-v-fea59dc5${ssrIncludeBooleanAttr(Array.isArray(selectedBranch.value) ? ssrLooseContain(selectedBranch.value, b.id) : ssrLooseEqual(selectedBranch.value, b.id)) ? " selected" : ""}${_scopeId}>${ssrInterpolate(b.name)}</option>`);
						});
						_push(`<!--]--></select><button class="ui-btn ui-btn--ghost"${ssrIncludeBooleanAttr(saving.value) ? " disabled" : ""} data-v-fea59dc5${_scopeId}>${ssrInterpolate(saving.value ? "Saving…" : "💾 Save Layout")}</button>`);
						if (unref(can)("reservations.update")) _push(`<button class="ui-btn ui-btn--primary" data-v-fea59dc5${_scopeId}>+ Add Table</button>`);
						else _push(`<!---->`);
					} else return [
			...
			_push(`<div class="fp__legend" data-v-fea59dc5><!--[-->`);
			ssrRenderList(statusColors, (color, status) => {
				_push(`<span class="fp__legend-item" data-v-fea59dc5><span class="fp__legend-dot" style="${ssrRenderStyle({ background: color })}" data-v-fea59dc5></span>${ssrInterpolate(status)}</span>`);
			});
			_push(`<!--]--></div><div class="fp__canvas" data-v-fea59dc5>`);
			if (props.todayReservations.length) {
				_push(`<div class="fp__reservations-strip" data-v-fea59dc5><span class="fp__strip-label" data-v-fea59dc5>Today&#39;s reservations:</span><!--[-->`);
				ssrRenderList(props.todayReservations, (r) => {
					_push(`<span class="fp__res-chip" data-v-fea59dc5>${ssrInterpolate(fmtTime(r.reserved_at))} — ${ssrInterpolate(r.guest_name)} (${ssrInterpolate(r.party_size)}) <span class="ui-badge ui-badge--info" style="${ssrRenderStyle({ "margin-left": "4px" })}" data-v-fea59dc5>${ssrInterpolate(r.status)}</span></span>`);
				});
				_push(`<!--]--></div>`);
			} else _push(`<!---->`);
			_push(`<!--[-->`);
			ssrRenderList(tables.value, (table) => {
				...
				], "fp__table"])}" style="${ssrRenderStyle(tableStyle(table))}" data-v-fea59dc5><span class="fp__table-num" data-v-fea59dc5>${ssrInterpolate(table.table_number)}</span><span class="fp__table-cap" data-v-fea59dc5>${ssrInterpolate(table.capacity)}p</span>`);
				if (table.current_order_type) _push(`<span class="fp__table-order" data-v-fea59dc5>${ssrInterpolate(typeEmoji(table.current_order_type))}</span>`);
				else _push(`<!---->`);
				_push(`</div>`);
			});
			_push(`<!--]--></div>`);
			if (selected.value) {
				_push(`<div class="fp__drawer" data-v-fea59dc5><div class="fp__drawer-hdr" data-v-fea59dc5><span data-v-fea59dc5>Table ${ssrInterpolate(selected.value.table_number)}</span><button class="fp__drawer-close" data-v-fea59dc5>✕</button></div><div class="fp__drawer-body" data-v-fea59dc5><p data-v-fea59dc5><strong data-v-fea59dc5>Capacity:</strong> ${ssrInterpolate(selected.value.capacity)}</p><p data-v-fea59dc5><strong data-v-fea59dc5>Status:</strong><select class="ui-input" style="${ssrRenderStyle({
					"width": "140px",
					"margin-left": "8px"
				})}" data-v-fea59dc5><!--[-->`);
				ssrRenderList(props.tableStatuses, (s) => {
					_push(`<option${ssrRenderAttr("value", s)} data-v-fea59dc5${ssrIncludeBooleanAttr(Array.isArray(selected.value.status) ? ssrLooseContain(selected.value.status, s) : ssrLooseEqual(selected.value.status, s)) ? " selected" : ""}>${ssrInterpolate(s)}</option>`);
				});
				_push(`<!--]--></select></p>`);
				if (selected.value.current_order_type) _push(`<p data-v-fea59dc5><strong data-v-fea59dc5>Order:</strong> ${ssrInterpolate(typeLabel(selected.value.current_order_type))}</p>`);
				else _push(`<!---->`);
				_push(`<div class="fp__drawer-actions" data-v-fea59dc5><button class="ui-btn ui-btn--ghost ui-btn--sm" data-v-fea59dc5>Edit Table</button><button class="ui-btn ui-btn--danger ui-btn--sm" data-v-fea59dc5>Delete</button></div></div></div>`);
			} else _push(`<!---->`);
			_push(ssrRenderComponent(Modal_default, {
				...
				footer: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`<button class="ui-btn ui-btn--ghost" data-v-fea59dc5${_scopeId}>Cancel</button><button class="ui-btn ui-btn--primary"${ssrIncludeBooleanAttr(unref(tableForm).processing) ? " disabled" : ""} data-v-fea59dc5${_scopeId}>Save</button>`);
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<div class="form-grid-2" data-v-fea59dc5${_scopeId}>`);
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) {
									...
									ssrRenderList(props.tableShapes, (s) => {
										_push(`<option${ssrRenderAttr("value", s)} data-v-fea59dc5${_scopeId}>${ssrInterpolate(s)}</option>`);
									});
									_push(`<!--]-->`);
						...
						_push(ssrRenderComponent(_sfc_main$2, {
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) {
									_push(`<option value="" data-v-fea59dc5${_scopeId}>Select branch</option><!--[-->`);
									ssrRenderList(props.branches, (b) => {
										_push(`<option${ssrRenderAttr("value", b.id)} data-v-fea59dc5${_scopeId}>${ssrInterpolate(b.name)}</option>`);
									});
									_push(`<!--]-->`);
...
var FloorPlan_default = /*#__PURE__*/ _plugin_vue_export_helper_default(_sfc_main, [["__scopeId", "data-v-fea59dc5"]]);
//#endregion
