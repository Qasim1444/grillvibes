import { computed, ref, watch, mergeProps, withCtx, unref, openBlock, createBlock, createCommentVNode, toDisplayString, createTextVNode, createVNode, Fragment, renderList, withDirectives, vModelCheckbox, useSSRContext } from "vue";
...
const _sfc_main = /* @__PURE__ */ Object.assign({ layout: AdminLayout }, {
  ...
  setup(__props) {
    ...
    const users = computed(() => {
      var _a2;
      return ((_a2 = props.users) == null ? void 0 : _a2.data) ?? [];
    });
    ...
    return (_ctx, _push, _parent, _attrs) => {
        ...
        actions: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (unref(can)("users.create")) {
              _push2(`<button class="ui-btn ui-btn--primary" data-v-ca9d86e9${_scopeId}>+ Add User</button>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
            return [
              unref(can)("users.create") ? (openBlock(), createBlock("button", {
                key: 0,
      ...
      _push(ssrRenderComponent(DataTable, {
        ...
        "cell:created_at": withCtx(({ value }, _push2, _parent2, _scopeId) => {
          if (_push2) {
        ...
        "cell:role_names": withCtx(({ value }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (value) {
              _push2(`<span class="ui-badge ui-badge--success" data-v-ca9d86e9${_scopeId}>${ssrInterpolate(value)}</span>`);
            } else {
              _push2(`<span class="ui-badge ui-badge--muted" data-v-ca9d86e9${_scopeId}>No role</span>`);
            }
          } else {
            return [
        ...
        actions: withCtx(({ row }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (unref(can)("users.update")) {
              _push2(`<button class="ui-btn ui-btn--ghost ui-btn--sm" data-v-ca9d86e9${_scopeId}>Edit</button>`);
            } else {
              _push2(`<!---->`);
            }
            if (unref(can)("users.update")) {
              _push2(`<button class="ui-btn ui-btn--secondary ui-btn--sm" data-v-ca9d86e9${_scopeId}>Assign Role</button>`);
            } else {
              _push2(`<!---->`);
            }
            if (unref(can)("users.delete")) {
              _push2(`<button class="ui-btn ui-btn--danger ui-btn--sm" data-v-ca9d86e9${_scopeId}>Delete</button>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
      ...
      _push(ssrRenderComponent(Modal, {
        ...
        footer: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<button class="ui-btn ui-btn--ghost" data-v-ca9d86e9${_scopeId}>Cancel</button><button class="ui-btn ui-btn--primary"${ssrIncludeBooleanAttr(unref(form).processing) ? " disabled" : ""} data-v-ca9d86e9${_scopeId}>Save</button>`);
          } else {
            return [
              createVNode("button", {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (errorMsg.value) {
              _push2(`<div class="ui-alert ui-alert--danger" data-v-ca9d86e9${_scopeId}>${ssrInterpolate(errorMsg.value)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            ...
            _push2(`<div class="ui-field" data-v-ca9d86e9${_scopeId}><label class="ui-label" data-v-ca9d86e9${_scopeId}>Roles</label><div class="users__roles" data-v-ca9d86e9${_scopeId}><!--[-->`);
            ssrRenderList(props.roles, (r) => {
              _push2(`<label class="users__role" data-v-ca9d86e9${_scopeId}><input type="checkbox"${ssrRenderAttr("value", r.id)}${ssrIncludeBooleanAttr(Array.isArray(unref(form).role_ids) ? ssrLooseContain(unref(form).role_ids, r.id) : unref(form).role_ids) ? " checked" : ""} data-v-ca9d86e9${_scopeId}><span data-v-ca9d86e9${_scopeId}>${ssrInterpolate(r.name)}</span></label>`);
            });
            _push2(`<!--]-->`);
            if (!props.roles.length) {
              _push2(`<p class="users__roles-empty" data-v-ca9d86e9${_scopeId}> No roles defined yet — create one on the Roles &amp; Permissions page. </p>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div>`);
            if (unref(form).errors.role_ids) {
              _push2(`<span class="ui-field__error" data-v-ca9d86e9${_scopeId}>${ssrInterpolate(unref(form).errors.role_ids)}</span>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div>`);
            ...
            return [
              ...
              createVNode("div", { class: "ui-field" }, [
                ...
                createVNode("div", { class: "users__roles" }, [
                  (openBlock(true), createBlock(Fragment, null, renderList(props.roles, (r) => {
                    return openBlock(), createBlock("label", {
                      ...
                      withDirectives(createVNode("input", {
                        ...
                        [vModelCheckbox, unref(form).role_ids]
                      ]),
                      createVNode("span", null, toDisplayString(r.name), 1)
                    ]);
                  }), 128)),
                  !props.roles.length ? (openBlock(), createBlock("p", {
                    key: 0,
      ...
      _push(ssrRenderComponent(Modal, {
        ...
        footer: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<button class="ui-btn ui-btn--ghost" data-v-ca9d86e9${_scopeId}>Cancel</button><button class="ui-btn ui-btn--primary"${ssrIncludeBooleanAttr(unref(assignForm).processing) ? " disabled" : ""} data-v-ca9d86e9${_scopeId}>Save</button>`);
          } else {
            return [
              createVNode("button", {
                class: "ui-btn ui-btn--ghost",
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<p class="assign-role__name" data-v-ca9d86e9${_scopeId}>User: <strong data-v-ca9d86e9${_scopeId}>${ssrInterpolate(unref(assignForm).userName)}</strong></p><div class="ui-field" data-v-ca9d86e9${_scopeId}><label class="ui-label" data-v-ca9d86e9${_scopeId}>Roles</label><div class="users__roles" data-v-ca9d86e9${_scopeId}><!--[-->`);
            ssrRenderList(props.roles, (r) => {
              _push2(`<label class="users__role" data-v-ca9d86e9${_scopeId}><input type="checkbox"${ssrRenderAttr("value", r.id)}${ssrIncludeBooleanAttr(Array.isArray(unref(assignForm).role_ids) ? ssrLooseContain(unref(assignForm).role_ids, r.id) : unref(assignForm).role_ids) ? " checked" : ""} data-v-ca9d86e9${_scopeId}><span data-v-ca9d86e9${_scopeId}>${ssrInterpolate(r.name)}</span></label>`);
            });
            _push2(`<!--]-->`);
            if (!props.roles.length) {
              _push2(`<p class="users__roles-empty" data-v-ca9d86e9${_scopeId}> No roles defined yet — create one on the Roles &amp; Permissions page. </p>`);
            ...
            _push2(`</div>`);
            if (unref(assignForm).errors.role_ids) {
              _push2(`<span class="ui-field__error" data-v-ca9d86e9${_scopeId}>${ssrInterpolate(unref(assignForm).errors.role_ids)}</span>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div>`);
            ...
            return [
              createVNode("p", { class: "assign-role__name" }, [
                createTextVNode("User: "),
                createVNode("strong", null, toDisplayString(unref(assignForm).userName), 1)
              ]),
              createVNode("div", { class: "ui-field" }, [
                createVNode("label", { class: "ui-label" }, "Roles"),
                createVNode("div", { class: "users__roles" }, [
                  (openBlock(true), createBlock(Fragment, null, renderList(props.roles, (r) => {
                    return openBlock(), createBlock("label", {
                      ...
                      withDirectives(createVNode("input", {
                        ...
                        [vModelCheckbox, unref(assignForm).role_ids]
                      ]),
                      createVNode("span", null, toDisplayString(r.name), 1)
                    ]);
                  }), 128)),
...
const Users = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-ca9d86e9"]]);
export {
  Users as default
};
