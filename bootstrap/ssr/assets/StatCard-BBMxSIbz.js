...
import { ssrRenderAttrs, ssrInterpolate, ssrRenderStyle, ssrRenderSlot, ssrRenderClass } from "vue/server-renderer";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ui-card stat-card" }, _attrs))} data-v-1947894d><div class="stat-card__top" data-v-1947894d><span class="stat-card__label" data-v-1947894d>${ssrInterpolate(__props.label)}</span><div class="stat-card__icon" style="${ssrRenderStyle({ background: __props.tint, color: __props.color })}" data-v-1947894d>`);
      ...
      if (__props.hint) {
        ...
        if (__props.trend) {
          _push(`<span class="${ssrRenderClass([trendClass.value, "stat-card__trend"])}" data-v-1947894d>${ssrInterpolate(__props.trend)}</span>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div>`);
...
const StatCard = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-1947894d"]]);
export {
  StatCard as S
};
