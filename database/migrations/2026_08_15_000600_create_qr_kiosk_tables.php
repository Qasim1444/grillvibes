...
/**
 * QR-code dine-in ordering & Kiosk mode:
 *
 ...
 *  kiosk_configs → per-branch kiosk settings (splash image, payment methods,
 *                  idle timeout, allowed order types).
 */
