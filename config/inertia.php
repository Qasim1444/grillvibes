...
return [
    ...
    */
    ...
    'devtools' => [
        ...
        // Opt-in only. Left unset, DevTools defaults to on in the `local`
        // environment and records every request's full prop payload to disk
        // (encode + decode passes). Pages that ship large eager-loaded
        // collections (orders, pos, customers) then exhaust PHP's memory_limit
        // and 500. Enable explicitly with INERTIA_DEVTOOLS_ENABLED=true only
        // when using the DevTools browser extension.
